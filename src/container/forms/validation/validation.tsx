              ...
              <form className="ti-validation">
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <SpkFlatpickr inputClass="ti-form-input" placeholder="Choose Date" onfunChange={(date:any) => setStartDate(date as Date)}  options={{dateFormat: "Y-m-d"}}  />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="my-5 flex items-center">
                  ...
                  <label htmlFor="hs-checkbox-group-1" className="!inline text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the 
                  <Link to={`${import.meta.env.BASE_URL}pages/terms-conditions/`} className="text-primary hover:underline ms-1">terms and conditions</Link></label>
                </div>
            ...
            <div className="box-body">
              <form className="ti-custom-validation" noValidate>
                ...
                <div className="my-5 flex items-center">
                  ...
                  <label htmlFor="hs-checkbox-group-12" className="!inline text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the 
                  <Link to={`${import.meta.env.BASE_URL}pages/terms- conditions/`} className="text-primary hover:underline">terms and conditions</Link></label>
                </div>
                <SpkButton defaultValue="Login Now" buttontype="submit" variant="primary-full" customClass="ti-btn ti-custom-validate-btn">Submit</SpkButton>
              </form>
            </div>
          </div>
        </div>
