...
import { switch1, switch10, switch2, switch3, switch4, switch5, switch6, switch7, switch8, switch9 } from '../../../../components/prism-code/forms-prism'
    ...
    <>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-6">
              <Showcode title="Toggle Switch With Tooltip" reactCode={switch2}>
                <SpkOverlay className="flex items-center">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-6 xl:col-span-4">
              <Showcode title="Toggle Switch With Sizes" reactCode={switch5}>
                <div className="space-y-4">
                  <div className="flex items-center">
              ...
              <Showcode title="Toggle Switch Validation States" reactCode={switch6}>
                <div className="space-y-4">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="hs-invalid-toggle-switch" className="ti-switch shrink-0 checked:!bg-red checked:!bg-red-600 checked:hover:!bg-red-600 
          ...
          <div className="col-span-12 lg:col-span-6 xl:col-span-4">
              <Showcode title="Solid Color Variants" reactCode={switch7}>
              ...
              <Showcode title="Solid Color With Icons" reactCode={switch8}>
                <div className="space-x-4 rtl:space-x-reverse">
                  <div className="relative inline-block">
          ...
          <div className="col-span-12 lg:col-span-6 xl:col-span-4">
              <Showcode title="Soft Color Variants" reactCode={switch9}>
                <div className="space-x-4 rtl:space-x-reverse">
                  <div className="relative inline-block">
              ...
              <Showcode title="Soft Color With Icons" reactCode={switch10}>
                <div className="space-x-4 rtl:space-x-reverse">
                  <div className="relative inline-block">
