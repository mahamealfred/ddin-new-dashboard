...
import { counter1, counter2, counter3, counter4 } from '../../../../components/prism-code/forms-prism'
                    ...
                    <div className="col-span-12 xxl:col-span-6">
                            <Showcode title="Checkbox Toggle Count" reactCode={counter1}>
                                <div className="flex justify-end mb-3">
                                    ...
                                    <label htmlFor="toggle-count-monthly" className="relative inline-block py-2 px-3 me-1">
                            ...
                            <Showcode title="Basic Markup" reactCode={counter3}>
                                ...
                                <p className="mt-3 text-end">
                                    <SpkButton buttontype="button" Copymarkup='{
                                        ...
                                        "limit": 10
                                    }' Id="hs-copy-content" customClass="py-1.5 px-2 inline-flex items-center gap-x-1 text-xs font-medium rounded-full border border-dashed border-gray-200 bg-white text-gray-800 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-bodybg dark:border-white/10 dark:text-white/70 dark:hover:bg-bgdark dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-primary">
                            ...
                            <Showcode title="Select Markup" reactCode={counter4}>
                                ...
                                <p className="mt-3 text-end">
                                    <SpkButton type="button" Copymarkup='{
                                            ...
                                            "limit": 3
                                        }' Id="hs-copy-select-content" customClass="py-1.5 px-2 inline-flex items-center gap-x-1 text-xs font-medium rounded-full border border-dashed border-gray-200 bg-white text-gray-800 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-bodybg dark:border-white/10 dark:text-white/70 dark:hover:bg-bgdark dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-primary">
                                        <svg className="flex-shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                                        Add Option
                                    </SpkButton>
                                </p>
