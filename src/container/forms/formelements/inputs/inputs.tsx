...
import { input1, input10, input11, input12, input13, input14, input15, input16, input17, input18, input19, input2, input20, input21, input22, input23, input24, input25, input26, input27, input3, input4, input5, input6, input7, input8, input9 } from '../../../../components/prism-code/forms-prism';
        ...
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6 text-defaultsize">
                    <div className="xl:col-span-12 col-span-12">
                            <Showcode title="Input Types" reactCode={input1}>
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="xl:col-span-6 col-span-12">
                            <Showcode title="Input shapes" reactCode={input2}>
                    ...
                    <div className="xl:col-span-6 col-span-12">
                            <Showcode title="Input border Styles" reactCode={input3}>
                                <div className="grid grid-cols-12 gap-y-3">
                                    <div className="xl:col-span-12 col-span-12">
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="xl:col-span-12 col-span-12">
                            <Showcode title="Input Sizing" reactCode={input4}>
                ...
                <div className="grid grid-cols-12 gap-x-6">
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Basic Inputs" reactCode={input5}>
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Inputs With Placeholder" reactCode={input6}>
                                <div className="max-w-sm space-y-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Disabled Inputs" reactCode={input7}>
                                <div className="max-w-sm space-y-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Gray Inputs" reactCode={input8} customCardBodyClass="space-y-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Underline Inputs" reactCode={input9} customCardBodyClass="space-y-3">
                                <div className="relative">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Floating label" reactCode={input10} customCardBodyClass="space-y-3">
                                <div className="relative">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Gray Floating label" reactCode={input11} customCardBodyClass="space-y-3">
                                <div className="relative">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Underline Floating label" reactCode={input12} customCardBodyClass="space-y-3 underlined-floatiing-label">
                                <div className="relative">
                ...
                <div className="grid grid-cols-12 gap-x-6">
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Pilled Inputs" reactCode={input13} customCardBodyClass="space-y-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Input With Hidden Label" reactCode={input14} customCardBodyClass="space-y-3">
                                <div className="">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Inputs With Label" reactCode={input15} customCardBodyClass="space-y-3">
                                <div className="">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Input With Helper text" reactCode={input16} customCardBodyClass="space-y-3">
                                <div>
                    ...
                    <div className="col-span-12 xxl:col-span-4">
                            <Showcode title="Input With Inline helper text" reactCode={input17} customCardBodyClass="space-y-3">
                    ...
                    <div className="col-span-12 xxl:col-span-4">
                            <Showcode title="Input With Corner Hint" reactCode={input18} customCardBodyClass="space-y-4">
                                <div>
                    ...
                    <div className="col-span-12 xxl:col-span-4">
                            <Showcode title="Input Validation states" reactCode={input19} customCardBodyClass="">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Input Sizes" reactCode={input20} customCardBodyClass="">
                                <div className="space-y-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Textarea Sizes" reactCode={input21} customCardBodyClass="">
                                <div className="space-y-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">                            
                            <Showcode title=" Textarea examples" reactCode={input22} customCardBodyClass="space-y-3">
                                <div className="relative">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex items-center">
                                                <SpkButton buttontype="button"
                                                    customClass="inline-flex flex-shrink-0 justify-center items-center size-8 rounded-lg text-gray-500 dark:text-white/70 hover:text-primary focus:z-10 focus:outline-none focus:ring-0 shadow-none focus:ring-primary dark:hover:text-primary dark:focus:outline-none dark:focus:ring-0 dark:focus:ring-gray-600">
                                            ...
                                            <div className="flex items-center gap-x-1">
                                                ...
                                                <SpkButton buttontype="button"
                                                    customClass="inline-flex flex-shrink-0 justify-center items-center size-8 rounded-sm text-white bg-primary hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 shadow-none focus:ring-primary dark:focus:outline-none dark:focus:ring-0 dark:focus:ring-gray-600">
                    ...
                    <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
                            <Showcode title="Autoheight" reactCode={input23} customCardBodyClass="">
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="xl:col-span-6 col-span-12">
                            <Showcode title="Overview" reactCode={input24} customCardBodyClass="">
                                <form>
                                    <div className="mb-3">
                                    ...
                                    <SpkButton buttontype="submit" variant="primary-full" customClass="ti-btn">Submit</SpkButton>
                                </form>
                                </Showcode>
                    </div>
                    <div className="xl:col-span-6 col-span-12">
                        <div className="grid grid-cols-12">
                            <div className="xl:col-span-12 col-span-12">
                                    <Showcode title="Form text" reactCode={input25} customCardBodyClass="">
                            ...
                            <div className="xl:col-span-12 col-span-12">
                                    <Showcode title=" Inline text can use any typical inline HTML element with nothing more
                                            than
                                            the <span class='text-danger'>.form-text</span> class." reactCode={input26} customCardBodyClass="">
                    ...
                    <div className="xl:col-span-6 col-span-12">
                            <Showcode title="Disabled forms" reactCode={input27} customCardBodyClass="">
                                <form>
                                    <fieldset disabled>
                                        ...
                                        <SpkButton buttontype="submit" variant="primary-full"
