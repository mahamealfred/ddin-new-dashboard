...
import { radio1,  radio11, radio12, radio13, radio14, radio2, radio3, radio4, radio5, radio6, } from '../../../../components/prism-code/forms-prism';
        ...
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <Showcode title="Checks" reactCode={radio1}>
                ...
                <div className="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <Showcode title="Radios" reactCode={radio3}>
                        <div className="form-check">
                ...
                <div className="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <Showcode title="Disabled" reactCode={radio4}>
                        <div className="form-check">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Default (stacked)" reactCode={radio5}>
                        <div className="form-check">
                ...
                <div className="xl:col-span-6 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Switches" reactCode={radio11} customCardBodyClass="flex flex-col gap-y-4">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Checkbox Sizes" reactCode={radio12} customCardBodyClass="sm:flex items-center justify-between">
                ...
                <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Radio Sizes" reactCode={radio13} customCardBodyClass="sm:flex items-center justify-between">
                        <div className='sm:flex'>
                            <div className="form-check me-5">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Inline" reactCode={radio14} customCardBodyClass="sm:flex gap-2">
                ...
                <div className="xl:col-span-6  lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Reverse" reactCode={radio6}>
