...
import { layout1, layout10, layout11, layout2, layout3, layout4, layout5, layout6, layout7, layout8, layout9 } from '../../../components/prism-code/forms-prism';
...
const Formlayouts: FC<FormlayoutsProps> = () => {
    return (
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Vertical Forms" reactCode={layout1}>
                        ...
                        <SpkButton variant="primary-full" customClass="ti-btn" buttontype="submit">Submit</SpkButton>
                    </Showcode>
                </div>
                <div className="xl:col-span-6 col-span-12">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Vertical Form With Icon" reactCode={layout3}>
                        ...
                        <SpkButton variant="primary-full" customClass="ti-btn !mb-0 mt-4" buttontype="submit">Submit</SpkButton>
                    </Showcode>
                </div>
                <div className="xl:col-span-6 col-span-12">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Inline Forms" reactCode={layout5}>
                        <form className="sm:grid grid-cols-4 gap-4 items-center">
                            ...
                            <SpkButton variant="primary-full" buttontype="submit" customClass="ti-btn !mb-0 mt-4">Submit</SpkButton>
                        </form>
                    </Showcode>
                </div>
                <div className="xl:col-span-6 col-span-12">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Utilities" reactCode={layout11}>
                        <div className="mb-4">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Horizontal Form Label sizing" reactCode={layout7}>
                        <div className="grid grid-cols-12 mb-4">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-12 col-span-12">
                    <Showcode title="Auto Sizing" reactCode={layout8}>
                        <form className="sm:grid grid-cols-12 block gap-y-2 gap-x-4 items-center mb-4">
                            ...
                            <div className="col-span-12">
                                <SpkButton buttontype="submit" variant="primary-full" customClass="ti-btn !mb-0 mt-4">Submit</SpkButton>
                            </div>
                        </form>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Form Grid" reactCode={layout9}>
                        <div className="grid grid-cols-12 sm:gap-x-6 sm:gap-y-4">
                            ...
                            <div className="md:col-span-12 col-span-12">
                                <SpkButton buttontype="submit" variant="primary-full" customClass="ti-btn !mb-0">Sign in</SpkButton>
                            </div>
                        </div>
                    </Showcode>
                </div>
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Gutters" reactCode={layout10}>
