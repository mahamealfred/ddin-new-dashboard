...
const CompletedTrasactions: FC<SalesProps> = () => {
    ...
    return (
        <Fragment>
            <Pageheader currentpage="Completed Transactions" activepage="Dashboards" mainpage="Transactions" />
...
export default CompletedTrasactions