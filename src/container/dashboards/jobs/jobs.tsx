...
import {  acquisitionsBadge, Candioptions, Candiseries, Jobusers, Recentemployers, Registersbycountry, registrations, Suboptions, Subseries, TopCompanies } from '../../../components/ui/data/dashboards/jobsdata'
import { Link } from 'react-router-dom';
import Pageheader from '../../../components/common/page-header/pageheader';
import ApexchartsComponent from '../../../@spk/spk-packages/apexcharts-component';
import SpkJobsCards from '../../../@spk/dashboards/spk-jobscards';
                ...
                <div className="xxxl:col-span-6 col-span-12">
                    <div className="grid grid-cols-12 gap-x-6">
                        <div className="xxl:col-span-4 md:col-span-6 col-span-12">
                                <SpkJobsCards title="TOTAL EMPLOYERS"  ratio="256" 
                                        svg={<><svg className="svg-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                            <path d="M0 0h24v24H0V0z" fill="none" />
                                    <path d="M12 5.9c1.16 0 2.1.94 2.1 2.1s-.94 2.1-2.1 2.1S9.9 9.16 9.9 8s.94-2.1 2.1-2.1m0 9c2.97 0 6.1 1.46 6.1 2.1v1.1H5.9V17c0-.64 3.13-2.1 6.1-2.1M12 4C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 9c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z" /> </svg></>} 
                                  text="-1.05%" color="bg-primary" />
                        </div>
                        <div className="xxl:col-span-4 md:col-span-6 col-span-12">
                            <SpkJobsCards title="TOTAL CANDIDATES"  ratio="4,026" 
                                    svg={<>
                              ...
                              text="+0.40%" color="bg-secondary" />
                        </div>
                        <div className="xxl:col-span-4 md:col-span-6 col-span-12">
                            <SpkJobsCards title="TOTAL LOCATIONS"  ratio="48" 
                                    svg={<>
                                        <svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                                ...
                                text="+0.82%" color="bg-warning" />
                        </div>
                        <div className="xxl:col-span-4 md:col-span-6 col-span-12">
                            <SpkJobsCards title="TOTAL RECRUITERS"  ratio="1,116" 
                                        svg={<>
                                            <svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                                                        enableBackground="new 0 0 24 24" height="24px"
                                                        viewBox="0 0 24 24" width="24px" fill="#000000">
                                ...
                                text="+0.21%" color="bg-success" />
                        </div>
                        <div className="xxl:col-span-4 md:col-span-6 col-span-12">
                            <SpkJobsCards title="TOTAL SUBSCRIPTIONS"  ratio="1,468" 
                                        svg={<>
                                        <svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                                                height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                                <path d="M0 0h24v24H0V0z" fill="none" />
                            ...
                            text="-0.153" color="bg-pinkmain" />

                        </div>
                        <div className="xxl:col-span-4 md:col-span-6 col-span-12">
                                <SpkJobsCards title="RESSUME UPLOAD RATIO"  ratio="34%" 
                                    svg={<>
                                        <svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                                            enableBackground="new 0 0 24 24" height="24px"
                                            viewBox="0 0 24 24" width="24px" fill="#000000">
                            ...
                            <div className="box overflow-hidden">
                                ...
                                <div className="box-body !p-0">
                                    ...
                                    <div id="subscriptionOverview" className="px-3 sm:mt-0 mt-3">
                                       <ApexchartsComponent chartOptions={Suboptions} chartSeries={Subseries} type="line" height={290} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="box overflow-hidden">
                                ...
                                <div className="box-body !p-0 ">
                                   <SimpleBar id="recent-jobs">
                                    <ul className="list-group list-group-flush max-h-[24rem]">
                                        {Jobusers.map((idx)=>(
                                            <li className={`list-group-item ${idx.class}`} key={Math.random()}>
                                                <Link to="#">
                                                    <div className="flex items-center">
                                                        <div className="me-2 leading-none">
                                                            <span className={`!text-${idx.bgColor} inline-flex items-center justify-center avatar avatar-md avatar-rounded bg-${idx.bgColor}/10`}>
                                                               {idx.initials}
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div className="text-end">
                                                            <p className="mb-0 text-[0.75rem]">{idx.content}</p>
                                                            <SpkBadge variant={`${idx.color}/10`} customClass={`!text-${idx.color}`}>{idx.somecontent}</SpkBadge>
                                                        </div>
                                                    </div>
                                                </Link>
                                            </li>
                            ...
                            <div className="box overflow-hidden">
                                ...
                                <div className="box-body !p-0">
                                    <div id="candidates-chart" className="p-3">
                                        <ApexchartsComponent chartOptions={Candioptions} chartSeries={Candiseries} type="donut" height={225} />
                                    </div>
                                            ...
                                            <div className="col" key={Math.random()}>
                                                <div className="p-4 md:border-e border-inline-e-dashed dark:border-white/10">
                                                    <div className="flex items-start !mb-6">
                                                        ...
                                                        <div className="flex-grow">
                                                            <div className="recent-recruiter">
                                                                <Link to="#" className="font-semibold mb-0 text-truncate">{idx.name}</Link>
                                                                <p className="mb-0 text-[0.75rem] text-[#8c9097] dark:text-white/50 text-truncate">{idx.email}</p>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <SpkButton Label="button" buttontype="button" customClass="rtl:rotate-180 ti-btn ti-btn-sm ti-btn-light ti-btn-wave">
                                                    ...
                                                    <div className="flex items-start justify-between mb-0">
                                                        ...
                                                        <div>
                                                            <SpkBadge variant={`${idx.badgeColor}/10`} customClass={`text-${idx.badgeColor}`}>{idx.badgeText}</SpkBadge>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                    ...
                    <div className="box overflow-hidden">
                        ...
                        <div className="box-body !p-0">
                            <div className="table-responsive">
                                <Spktables tableClass="table whitespace-nowrap min-w-full"  header={[{title:'Country', headerClassname:'text-start'}, {title:'Date', headerClassname:'text-start'}, 
                                    {title:'Total Registers', headerClassname:'text-start'}, {title:'Action', headerClassname:'text-start'} ]}>
                                        {Registersbycountry.map((idx) => (
                                            <tr className="border border-defaultborder dark:border-defaultborder/10 !border-x-0" key={Math.random()}>
                                                ...
                                                <td>{idx.total}</td>
                                                <td>
                                                    <SpkButton buttontype="button" variant="success" Size="sm" customClass="!px-2 !py-1 rounded-sm ti-btn-wave">View</SpkButton>
                                                </td>
                                            </tr>
                                        ))}
                                </Spktables>
                ...
                <div className="xxl:col-span-5 col-span-12">
                    <div className="box overflow-hidden">
                        ...
                        <div className="box-body !p-0">
                            <div className="table-responsive">
                                <Spktables tableClass="table table-hover whitespace-nowrap min-w-full"  header={[{title:'Name', headerClassname:'text-start'}, {title:'Subscription', headerClassname:'text-start'}, 
                                    {title:'Total Employees', headerClassname:'text-start'}, {title:'Recruiter Since', headerClassname:'text-start'} ]}>
                                        {TopCompanies.map((idx) => (
                                            <tr className="border hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10 border-defaultborder !border-x-0" key={Math.random()}>
                                                ...
                                                <td>
                                                    <SpkBadge variant={`${idx.color}/10`} customClass={`text-${idx.color}`}>{idx.text2}</SpkBadge>
                                                </td>
                                                <td>{idx.total}</td>
                                                <td>{idx.date}</td>
                                            </tr>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            ...
                            <ul className="list-group">
                                {acquisitionsBadge.map((idx)=>(
                                <li className="list-group-item !py-3" key={Math.random()}>
                                    {idx.title}
                                    <SpkBadge variant={`${idx.color}/10`} customClass={`ltr:float-right rtl:float-left  text-${idx.color}`}>{idx.badgeText}</SpkBadge>
                                </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <div className="box box-card">
                        <div className="box-header justify-between flex">
                            ...
                            <SpkDropdown Arrowicon={true} Linktag={true}  arialexpand={false} Customclass="" Toggletext="Sort By" 
                                Linkclass="ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem] !m-0 !gap-0 !font-medium  !hover:text-white">
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                    to="#">New</Link></li>
                                <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                    to="#">Popular</Link></li>
                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <Spktables tableClass="table whitespace-nowrap table-hover border table-bordered min-w-full" showCheckbox={true}
                                 header={[{title:'Employer', headerClassname:'text-start'}, {title:'Category', headerClassname:'text-start'}, 
                                    {title:'Role', headerClassname:'text-start'}, {title:'Mail', headerClassname:'text-start'},{title:'Location', headerClassname:'text-start'},
                                    {title:'Date', headerClassname:'text-start'} , {title:'Action', headerClassname:'text-start'}]}
                                >
                                    {Data.map((idx) => (
                                        <tr className="border hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10 border-defaultborder !border-x-0" key={Math.random()}>
                                            ...
                                            <td>{idx.place}</td>
                                            <td><SpkBadge variant={`${idx.color}/10`} customClass={`text-${idx.color}`}>{idx.role}</SpkBadge></td>
                                            <td>{idx.mail}</td>
                                            <td>
