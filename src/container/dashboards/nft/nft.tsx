...
import {  TopCollectors,  TrendingNFTs, TrendingNFTs1,  Trendingauctions} from '../../../components/ui/data/dashboards/nftdata'
import * as Nftdata from "../../../components/ui/data/dashboards/nftdata";
...
import SpkNFTCards from '../../../@spk/dashboards/spk-nftcards';
        ...
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div className="sm:col-span-8 pe-2 col-span-12 my-auto">
                                        <div className="my-auto">
                                            ...
                                            <div className="btn-list pt-1">
                                                <SpkButton buttontype="button" variant="primary" customClass="ti-btn !text-white ti-btn-wave m-1 !bg-primary waves-effect waves-light">Discover Now</SpkButton>
                                                <SpkButton buttontype="button" variant="outline-primary" customClass="ti-btn ti-btn-wave m-1 waves-effect waves-light">Create Yours</SpkButton>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="xxl:col-span-2 col-span-12">
                    <div className="xxl:col-span-12 col-span-12">
                        <SpkNFTCards Svg={<svg className="svg-white" xmlns="http://www.w3.org/2000/svg" height="24px"
                            ...
                            Color="primary" Percentagevalue="0.25%" Value="596" Titletext="Total Assets"
                            />
                    </div>
                    <div className="xxl:col-span-12  col-span-12">
                        <SpkNFTCards Svg={ <svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                            ...
                            Color="success" Percentagevalue="1.52%" Value="821" Titletext="Total Sales"
                            />
                    </div>
                </div>
                <div className="xxl:col-span-2 col-span-12">
                    ...
                    <SpkNFTCards Svg={<svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                            ...
                            Color="secondary" Percentagevalue="0.74%" Value="$1,298" Titletext="Total Value"
                            />
                    </div>
                    <div className="xxl:col-span-12 col-span-12">
                    <SpkNFTCards Svg={<svg className="svg-white" xmlns="http://www.w3.org/2000/svg"
                            ...
                            Color="warning" Percentagevalue="0.124%" Value="$7,63,129.09" Titletext="Total Revenue"
                            />
                    </div>
                </div>
                <div className="xxl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            ...
                            <div id="nft-balance-chart" className="px-4 py-6">
                                 <ApexchartsComponent chartOptions={Nftdata.Balanceoptions} chartSeries={Nftdata.Balanceseries} type="line" height={40} />
                            </div>
                            <div className="grid mt-3">
                                <SpkButton buttontype="button" variant="success" customClass="ti-btn !py-1 !px-2 ti-btn-wave !text-[0.75rem] !font-semibold">Top Up Wallet</SpkButton>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xxl:col-span-8 xl:col-span-12 lg:col-span-12 col-span-12">
                    <div className="mb-4 flex items-center justify-between">
                        ...
                        <div>
                            <SpkButton buttontype="button" variant="primary" customClass="tibtn !py-1 !px-[0.5rem] rounded-sm  text-[0.75rem] ti-btn-wave">View All</SpkButton>
                        </div>
                    </div>
                ...
                <div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 col-span-12">
                    <div className="box overflow-hidden">
                        <div className="box-header justify-between">
                            ...
                            <SpkDropdown Customclass="" Linktag={true} arialexpand={false} Arrowicon={true}  Toggletext="View All"
                        ...
                        <div className="box-body !p-0">
                            <div className="table-responsive">
                                <Spktables tableClass="table whitespace-nowrap min-w-full"
                                    header={[{title:'Name', headerClassname:'text-start'}, {title:'Items Sold', headerClassname:'text-start'}, 
                                    {title:'Total Value', headerClassname:'text-start'},{title:'Action', headerClassname:'text-start'} ]}>
                                        {Nftdata.topCreators.map((idx)=>(
                                            <tr className="border !border-x-0 border-defaultborder dark:border-defaultborder/10" key={Math.random()}>
                                                <td>
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="items-center">
                                                            <p className="mb-0 font-semibold">{idx.name}<i
                                                                className="bi bi-patch-check-fill text-success ms-2"></i>
                                                            </p>
                                                            <span
                                                                className="text-[0.75rem] text-[#8c9097] dark:text-white/50">{idx.username}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="items-center">
                                                        ...
                                                        <p className="mb-0 font-semibold">{idx.totalSold}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="items-center">
                                                ...
                                                <td>
                                                    <SpkButton buttontype="button" variant={idx.color}
                                                        customClass={`ti-btn !py-1 !px-2 !text-[0.75rem]  text-white ti-btn-wave`}>{idx.following}</SpkButton>
                                                </td>
                                            </tr>
                                        ))}
                                </Spktables>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xxl:col-span-3 xl:col-span-12 lg:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <SimpleBar
                         className="box-body !p-0 max-h-[28.5rem]" id="top-collector">
                            <div className="table-responsive">

                                <Spktables tableClass="table ti-custom-table-hover whitespace-nowrap min-w-full">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div id="nft-statistics" className="p-3">
                                 <ApexchartsComponent chartOptions={Nftdata.NFToptions} chartSeries={Nftdata.NFTseries} type="line" height={338} />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="xxl:col-span-3 xl:col-span-4 lg:col-span-5 md:col-span-12 sm:col-span-12 col-span-12">
                    <div className="mb-4 flex items-center justify-between">
                        ...
                        <div>
                            <SpkButton buttontype="button" variant="primary" customClass="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-wave waves-effect waves-light">View All</SpkButton>
                        </div>
                    </div>
                    <div className="swiper pagination-dynamic text-start" id="nft-collections-slide">
                        <div className="swiper-wrapper">
                                <SwiperComponent slides={Nftdata.NftSwiperSlide} spaceBetween={30} centeredSlides={true} autoplay={true} className='mySwiper swiper swiper-basic' />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="box">
                        <div className="box-header justify-between">
                            ...
                            <div className="flex">
                                ...
                                <SpkDropdown Customclass="" Linktag={true} arialexpand={false} Arrowicon={true}  Toggletext="Sort By"
                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <Spktables tableClass="table table-hover table-bordered whitespace-nowrap min-w-full"
                                     header={[{title:'Collection', headerClassname:'text-start'}, {title:'Rank', headerClassname:'text-start'}, 
                                    {title:'Volume', headerClassname:'text-start'}, {title:'24h %', headerClassname:'text-start'},{title:'7d %', headerClassname:'text-start'},
                                    {title:'Floor Price', headerClassname:'text-start'} , {title:'Items', headerClassname:'text-start'}]}>
                                            ...
                                            <tr className="border border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10" key={Math.random()}>
                                                <td className='min-w-52'>
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <p className="mb-0 font-semibold"><Link to="#" title="nft_name">{idx.name}</Link></p>
                                                            <Link to="#" className="text-[0.75rem] text-[#8c9097] dark:text-white/50 font-normal" title="creator_name">{idx.mail}</Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div className="flex items-center w-[6rem]">
                                                        <img src={ethereum} alt="" className="avatar avatar-xs avatar-rounded me-2 leading-none" />
                                                        <div>
                                                            <p className="mb-0 font-semibold"><Link to="#" title="nft_name">{idx.volume}</Link></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="flex items-center w-[6rem]">
                                                        <img src={ethereum} alt="" className="avatar avatar-xs avatar-rounded me-2 leading-none" />
                                                        <div>
                                                            <p className="mb-0 font-semibold"><Link to="#" title="nft_name">{idx.price}</Link></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>{idx.items}</td>
                                        ...
                                        <Link to="#">
                                            <div className="flex flex-wrapitems-center justify-between">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="mb-0 font-semibold flex items-center"><span className="avatar avatar-sm p-1 !mb-0"><img src={ethereum} alt="" /></span>{idx.price}</p>
                                                </div>
                                            </div>
                                        </Link>
                                    </li>
