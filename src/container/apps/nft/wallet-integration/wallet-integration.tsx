                    ...
                    <div className="xl:col-span-9 col-span-12">
                        <div className="box custom-box">
                            <div className="box-header justify-between">
                                ...
                                <div>
                                    <SpkButton variant="secondary-full" buttontype="button" customClass="ti-btn ti-btn-secondary-full btn-wave">Add New Wallet</SpkButton>
                                </div>
                            </div>
                            ...
                            <div className="box-footer">
                                <div>
                                    <SpkButton buttontype="button" variant="success-full" customClass="ti-btn ltr:float-right rtl:float-left btn-wave">Connect</SpkButton>
                                </div>
                            </div>
                        </div>
                    </div>
