...
import { Productdetailsdata, Progressdata, Tabledata } from '../../../../components/ui/data/apps/nft/nftdetailsdata';
...
const Nftdetails: FC<NftdetailsProps> = () =>{
    ...
    const NftSwiper = [
      ...
      <img className="img-fluid !rounded-md" src={image32} alt="img" />
  </div>,
  <div className="image-container">
      <img className="img-fluid !rounded-md" src={image31} alt="img" />
  </div>,
  <div className="image-container">
      <img className="img-fluid !rounded-md" src={image30} alt="img" />
  </div>,
  <div className="image-container">
      <img className="img-fluid !rounded-md" src={image33} alt="img" />
  </div>
    ]
                    ...
                    <div className="box-body">
                        ...
                        <div className="grid grid-cols-12 md:gap-x-[3rem]">
                            <div className="xl:col-span-4 col-span-12">
                                ...
                                <SwiperComponent slides={NftSwiper} loop={true} spaceBetween={10} navigation={true} thumb={{ swiper: thumbsSwiper}} className='mySwiper2  swiper-preview-details bg-light product-details-page switcher-nft-details rounded-md'/>
                                <SwiperComponent  onswiper={setThumbsSwiper} slidesPerView={4} slides={NftSwiper} spaceBetween={10} className='mySwiper swiper swiper-view-details mt-2' freemode={true} watchslide={true}/>
                                    <div className="grid mt-4">
                                        <SpkButton buttontype="button" variant="primary-full" customClass="ti-btn btn-wave">Place a bid</SpkButton>
                                    </div>
                                </div>
                                <div className="md:block hidden">
                                    ...
                                    <div className="table-responsive">
                                                <Spktables tableClass='table table-bordered whitespace-nowrap min-w-full'>
                                                                    ...
                                                                    <Link to="#">
                                                                        <div className="flex items-start">
                                                                            ...
                                                                            <div className="flex-grow">
                                                                                <p className="mb-1 text-[0.875rem] font-semibold similar-product-name text-truncate">{idx.text1}</p>
                                                                                <p className="mb-0">
                                                                                    <SpkBadge variant="success" customClass="!text-white">{idx.text2}<i className="ri-heart-3-fill align-middle ms-1"></i></SpkBadge>
                                                                                    <span className="text-[#8c9097] dark:text-white/50 ms-1">{idx.text3}</span>
                                                                                </p>
                                                                            </div>
                                                                            <div className="text-center">
                                                                                <p className="mb-0 text-[1rem] font-semibold">
                                                                                    <span className="avatar avatar-xs avatar-rounded p-1"><img src={ethereumreg} alt="" /></span>{idx.text4}
                                                                                </p>
                                                                                <p className="mb-0 text-[#8c9097] dark:text-white/50">
                                                                                    <s><span className="avatar avatar-xs avatar-rounded p-1"><img src={ethereumreg} alt="" /></span>{idx.text5}</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </Link>
                                                    ...
                                                    <td className="grid">
                                                        <SpkButton buttontype="button" variant="primary" customClass="ti-btn">View All NFT's</SpkButton>
                                                    </td>
                                                </Spktables>
                                    </div>
                                </div>
                            ...
                            <div className="xl:col-span-8 col-span-12">
                                <div className="xxl:mt-0 mt-4">
                                    ...
                                    <p className="text-[1.125rem] mb-4">
                                        ...
                                        <span className="font-semibold text-[#8c9097] dark:text-white/50"><Link className="text-info text-[0.875rem] ms-2" to="#">(2.4k Likes)</Link></span>
                                    </p>
                                    <div className="grid grid-cols-12 mb-6">
                                        <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
                                            ...
                                            <p className="mb-1"><span className="h3"><span className="avatar avatar-sm avatar-rounded p-1 bg-light me-1"><img src={ethereumreg} alt="" /></span>1.299<sup className="text-[0.875rem]">.00</sup></span>
                                            <SpkBadge variant="danger/10" customClass="ms-3 text-danger">50% Off</SpkBadge></p>
                                        ...
                                        <div className="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12  col-span-12 xxl:mt-0 mt-4">
                                            ...
                                            <div className="flex items-center font-semibold">
                                                <span className="avatar avatar-xs avatar-rounded leading-none me-1"><img src={face9} alt="" /></span>
                                                Json Taylor
                                            </div>
                                        </div>
                                            ...
                                            <div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                                ...
                                                {Progressdata.map((idx:any)=>(
                                                    <div className="flex items-center mb-4" key={Math.random()}>
                                                        <div className="text-[0.75rem] me-2 font-semibold">{idx.text1}</div>
                                                        <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                        <div className="progress progress-xs flex-grow">
                                                            <div className={`progress-bar !bg-success !text-white w-[${idx.now}%]`} aria-valuenow={idx.now} aria-valuemin={0} aria-valuemax={100}>
                                                            </div>
                                                        </div>
                                                        <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">({idx.text2})</div>
                                                    </div>
                                                ))}
                                            </div>
                                                    ...
                                                    <div className="product-images sm:!ps-4 !ps-0">
                                                        <div className="grid grid-cols-12 sm:gap-6">
                                                            ...
                                                            <div className="xl:col-span-6 col-span-12 flex items-end sm:justify-end sm:mt-0 mt-2 flex-wrap">
                                                                <SpkButton buttontype="button" variant="light" customClass="ti-btn !py-1 !px-2 !text-[0.75rem] me-2">Report abuse</SpkButton>
                                                                <SpkButton Label="button" buttontype="button" variant='primary' Size="sm" customClass="ti-btn me-2">
                                                                    <i className="ri-thumb-up-line"></i>
                                                                </SpkButton>
                                                                <SpkButton Label="button" buttontype="button" variant='primary' Size="sm"  customClass="ti-btn">
