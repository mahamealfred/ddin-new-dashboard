...
import { JobSwiper } from '../../../../components/ui/data/apps/jobs/jobdetailsdata';
                        ...
                        <div className="sm:flex align-top justify-between">
                            <div>
                                <div className="sm:flex flex-wrap gap-2">
                                    <span className="avatar avatar-rounded avatar-lg"> <img src={logo8} alt="" /> </span>
                                    <div>
                                        <h4 className="font-bold mb-0 flex items-center"><Link to="#">UI Developer - Fresher</Link></h4>
                                        <Link to="#" className="font-semibold"><i className="bi bi-building"></i> Spruko Technologies .PVT.LTD</Link>
                                        ...
                                        <div className="popular-tags mb-2 sm:mb-0">
                                            <SpkBadge variant="info/10"  customClass="me-2 !rounded-full text-info"><i className="bi bi-clock me-1"></i>Full Time</SpkBadge>
                                            <SpkBadge variant="danger/10" customClass="!rounded-full  text-danger"><i className="bi bi-briefcase me-1"></i>13 Openings</SpkBadge>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div className="btn-list sm:flex items-center mb-2">
                                    <Link to="#" className="ti-btn ti-btn-primary-full m-0 !me-[0.375rem]"> Apply Now</Link>
                                    <Link aria-label="anchor" to="#" className="ti-btn ti-btn-icon ti-btn-primary me-[0.375rem]">
                ...
                <div className="grid grid-cols-12 sm:gap-6">
                    <div className="xxl:col-span-8 col-span-12">
                            ...
                            <div className="box-body">
                                <div className="grid grid-cols-12 items-center">
                                    ...
                                    <div className="lg:col-span-6 col-span-12 text-end">
                                        <Link to="#" className="ti-btn ti-btn-success-full ti-btn-lg dark:!border-defaultborder/10">
                        ...
                        <div>
                            ...
                            <SwiperComponent slides={JobSwiper}  spaceBetween={30} autoplay={true} breakpoint={{ '@0.00': { slidesPerView: 1, spaceBetween: 10, }, '@2.00': { slidesPerView: 2, spaceBetween: 20, }}} navigation={true} className="mySwiper swiper-related-jobs" watchslide={true}/>
                        </div>
                    </div>
                    <div className="xxl:col-span-4 col-span-12">
                        <div className="box custom-box border dark:border-defaultborder/10">
                                ...
                                <ul className="list-group  list-group-flush">
                                    <li className="list-group-item !border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#"> React Lead Developer</Link></p>
                                    ...
                                    <li className="list-group-item border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#"> HTML Developer - Fresher</Link></p>
                                    ...
                                    <li className="list-group-item border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#"> Wordpress Developer - Remote</Link></p>
                                    ...
                                    <li className="list-group-item !border-b-0 !border-s-0 !border-e-0">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#"> Vuejs Frontend Developer</Link></p>
                            ...
                            <div className="box-footer">
                                <Link to="#" className="text-primary font-semibold text-[.875rem] mt-2">
                                ...
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item !border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#">Infratech PVT LTD</Link></p>
                                    ...
                                    <li className="list-group-item !border-s-0 !border-e-0  mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#">Spruko Technologies PVT LTD</Link></p>
                                    ...
                                    <li className="list-group-item !border-s-0 !border-e-0  mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#">Hardware Private Solutions </Link></p>
                                    ...
                                    <li className="list-group-item !border-b-0 !border-s-0 !border-e-0  mb-0">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link to="#"> G Technical Solutions</Link></p>
                            ...
                            <div className="box-body">
                                <div className="">
                                    ...
                                    <label className="form-check-label">
                                        By Subscribing you accept to <Link to="#" className="text-success mx-2"><u className='mx-1'> privacy policy </u></Link>
                                    </label>
                                </div>
                            </div>
                        </div>
