...
import { Buyoptions, Buyseries, Data1, Data2} from '../../../../components/ui/data/apps/crypto/buy&selldata';
                            ...
                            <div className="box-body crypto-data">
                                <div>
                                    <div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                        ...
                                        <SelectComponent option={Data1} mainClass="basic-multi-select" placeholder='BTC'/>
                                    </div>
                                    <div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                        ...
                                        <SelectComponent option={Data2} placeholder='USD'/>
                                    </div>
                                    <div>
                                    ...
                                    <div className="grid mt-6 pt-1">
                                        <SpkButton buttontype="button" variant="primary-full" size="lg" customClass="ti-btn btn-wave dark:border-defaultborder/10">BUY</SpkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="box custom-box">
                            ...
                            <div className="box-body crypto-data">
                                <div className="tab-pane !border-0 !p-0" id="sell-crypto1" role="tabpanel"
                                    ...
                                    <div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                        <input type="text" className="form-control crypto-buy-sell-input border-e-0 !border-s form-control-sm" aria-label="crypto buy select" placeholder="36,335.00" />
                                        <SelectComponent option={Data2} mainClass="basic-multi-select" placeholder='USD'/>
                                    </div>
                                    <div className="mb-4">
                                    ...
                                    <div className="grid mt-6">
                                        <SpkButton buttontype="button" variant="danger-full" size="lg" customClass="ti-btn btn-wave dark:border-defaultborder/10">SELL</SpkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="box custom-box">
                            ...
                            <div className="box-body">
                                <div className="tab-pane border-0 !p-0" id="sell-crypto" role="tabpanel"
                                    ...
                                    <div className="grid mt-6">
                                        <SpkButton buttontype="button" variant="success-full" size="lg" customClass="ti-btn btn-wave dark:border-defaultborder/10">Transfer</SpkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="box custom-box">
                            <div className="box-header justify-between">
                                ...
                                <div className="btn-group inline-flex flex-wrap" role="group" aria-label="Basic example">
                                    <SpkButton buttontype="button" variant="primary-full" customClass="ti-btn !rounded-e-none btn-wave">1D</SpkButton>
                                    <SpkButton buttontype="button" variant="primary" customClass="ti-btn !rounded-none  btn-wave">1W</SpkButton>
                                    <SpkButton buttontype="button" variant="primary" customClass="ti-btn !rounded-none  btn-wave">1M</SpkButton>
                                    <SpkButton buttontype="button" variant="primary" customClass="ti-btn !rounded-none  btn-wave">3M</SpkButton>
                                    <SpkButton buttontype="button" variant="primary" customClass="ti-btn !rounded-none  btn-wave">6M</SpkButton>
                                    <SpkButton buttontype="button" variant="primary" customClass="ti-btn !rounded-s-none  btn-wave">1Y</SpkButton>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-12 gap-6">
                                    <div className="xl:col-span-8 col-span-12 pe-0 border-e border-dashed dark:border-defaultborder/10">
                                        ...
                                        <div id="buy_sell-statistics" className="px-3">
                                             <ApexchartsComponent chartOptions={Buyoptions} chartSeries={Buyseries} type="line" height={300} />
                                        </div>
                                    </div>
