...
import { progress1, progress10, progress11, progress12, progress12data, progress13, progress14, progress15, progress16, progress17, progress18, Progress18data, progress19, progress2, progress3, progress4, progress5, progress6, progress7, progress8, progress9, progressdata14, progressdata2, progressdata5 } from '../../../components/prism-code/uielementsprism'
import { Custom, Gradient, animated, basicprogress, colorprogress, lables, stripped } from '../../../components/ui/data/ui-elements/progressdata'
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Basic Progress" reactCode={progress1} dataCode={progress1}>
                ...
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Different Colored Progress" reactCode={progress2} dataCode={progressdata2}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                <Showcode title="Striped Progress" reactCode={progress3} dataCode={progress3}>
                        {stripped.map((idx) => (
                ...
                <div className="xl:col-span-6 col-span-12">
                        ...
                        <Showcode title="Progress Height" reactCode={progress4} > 
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Progress With Labels" reactCode={progress5} dataCode={progressdata5}>
                            {lables.map((idx) => ( 
                ...
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Multiple Bars With Sizes" reactCode={progress6}>
                            ...
                            <div className="progress-stacked progress-lg mb-4 flex">
                                <div className="progress-bar !bg-purplemain w-1/5"
                                    role="progressbar" aria-valuenow={20} aria-valuemin={0} aria-valuemax={100}></div>
                                <div className="progress-bar !bg-primary !rounded-none w-1/4"
                                    role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}></div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Labels at The end" reactCode={progress7}>
                ...
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Progress With Title Label" reactCode={progress8} customCardBodyClass="space-y-4">
                            <div className="">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Progress With Steps" reactCode={progress9}  customCardBodyClass="space-y-4">
                ...
                <div className="xl:col-span-3 col-span-12">
                        <Showcode title="Vertical Progress" reactCode={progress10} customCardBodyClass="">
                ...
                <div className="xl:col-span-3 col-span-12">
                        <Showcode title="Circular progress" reactCode={progress11} customCardBodyClass="">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Animated Stripped Progress" reactCode={progress12} dataCode={progress12data}>
                        {animated.map((idx) => (
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Gradient Progress" reactCode={progress13} dataCode={progressdata14}>
                        {Gradient.map((idx) => (
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                     <Showcode title="Custom Animated Progress" reactCode={progress14} dataCode={progressdata14}>
                        {Gradient.map((idx) => (
                ...
                <div className="xl:col-span-6 col-span-12">
                <Showcode title="Custom Progress-1" reactCode={progress15} >
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Custom Progress-2" reactCode={progress16}>
                ...
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title=" Custom Progress-3" reactCode={progress17}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Custom Progress-4" reactCode={progress18} dataCode={Progress18data}>
                        {Custom.map((idx) => (
                ...
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Custom Progress-5" reactCode={progress19}>
