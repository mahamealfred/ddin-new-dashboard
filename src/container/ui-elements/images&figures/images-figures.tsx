...
import { image1, image2, image3, image4, image5, image6, image7, image8, image9 } from '../../../components/prism-code/uielementsprism'
        ...
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Responsive Image" reactCode={image1}>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image With Radius" reactCode={image2}>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Rounded Image" reactCode={image3}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image Left Align" reactCode={image4}>
                        <img className="!rounded-md float-start" src={media53} alt="..." />
                    </Showcode>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image Center Align" reactCode={image5}>
                        <img className="!rounded-md mx-auto block" src={media55} alt="..." />
                    </Showcode>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image Right Align" reactCode={image6}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Figures" reactCode={image7}>
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Image Thumbnail" reactCode={image8}>
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Image Thumbnail" reactCode={image9}>
