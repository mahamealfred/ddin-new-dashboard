                ...
                <div className="grid grid-cols-12 gap-x-6">
                  <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
                      <div className="box">
                          ...
                          <div className="box-body">
                            <div className="border-b-0 border-gray-200 dark:border-white/10">
                              <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                                <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" 
                                    Id="hs-tab-js-behavior-item-1" Tab="#hs-tab-js-behavior-1" Controls="hs-tab-js-behavior-1">
                                  Tab 1
                                </SpkButton>
                                <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" 
                                    Id="hs-tab-js-behavior-item-2" Tab="#hs-tab-js-behavior-2" Controls="hs-tab-js-behavior-2">
                                  Tab 2
                                </SpkButton>
                                <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" 
                                    Id="hs-tab-js-behavior-item-3" Tab="#hs-tab-js-behavior-3" Controls="hs-tab-js-behavior-3">
                                  Tab 3
                                </SpkButton>
                              </nav>
                            </div>
                            ...
                            <div className="">
                              <div 
                                  id="hs-tab-js-behavior-1" role="tabpanel" aria-labelledby="hs-tab-js-behavior-item-1">
                              ...
                              <div 
                                  id="hs-tab-js-behavior-2" className="hidden" role="tabpanel" aria-labelledby="hs-tab-js-behavior-item-2">
                                <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-ss-none rounded-sm dark:border-white/10 border-gray-200">
                              ...
                              <div 
                                  id="hs-tab-js-behavior-3" className="hidden" role="tabpanel" aria-labelledby="hs-tab-js-behavior-item-3">
                                <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-ss-none rounded-sm dark:border-white/10 border-gray-200">
                            ...
                            <div className="flex">
                              <div className="border-e border-gray-200 dark:border-white/10">
                                <nav className="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" data-hs-tabs-vertical="true" role="tablist">
                                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-transparent !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" 
                                      Id="hs-tab-js-vertical-item-1" Tab="#hs-tab-js-vertical-1" Controls="hs-tab-js-vertical-1">
                                    Tab 1
                                  </SpkButton>
                                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-transparent !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" 
                                      Id="hs-tab-js-vertical-item-2" Tab="#hs-tab-js-vertical-2" Controls="hs-tab-js-vertical-2">
                                    Tab 2
                                  </SpkButton>
                                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-transparent !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300"
                                       Id="hs-tab-js-vertical-item-3" Tab="#hs-tab-js-vertical-3" Controls="hs-tab-js-vertical-3">
                                     Tab 3
                                  </SpkButton>
                                </nav>
                              </div>
                              ...
                              <div className="">
                                <div 
                                    id="hs-tab-js-vertical-1" role="tabpanel" aria-labelledby="hs-tab-js-vertical-item-1">
                                ...
                                <div 
                                    id="hs-tab-js-vertical-2" className="hidden" role="tabpanel" aria-labelledby="hs-tab-js-vertical-item-2">
                                  <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                                    How travel coupons make you a better lover. Why cultural solutions are the new black. Why mom was right about travel insurances. How family trip ideas can help you predict the future. How carnival cruises make you a better lover. Why you'll never succeed at daily deals. 11 ways cheapest flights can find you the love of your life. The complete beginner's guide to mission trips. If you read one article about cultural notes read this one. Why you shouldn't eat vacation package in bed.
                                  </p>
                                </div>
                                <div 
                                    id="hs-tab-js-vertical-3" className="hidden" role="tabpanel" aria-labelledby="hs-tab-js-vertical-item-3">
                                  <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                                    Unbelievable healthy snack success stories. 12 facts about safe food handling tips that will impress your friends. Restaurant weeks by the numbers. Will mexican food ever rule the world? The 10 best thai restaurant youtube videos. How restaurant weeks can make you sick. The complete beginner's guide to cooking healthy food. Unbelievable food stamp success stories. How whole foods markets are making the world a better place. 16 things that won't happen in dish reviews.
                                  </p>
                                </div>
                      ...
                      <div className="box">
                          ...
                          <div className="box-body">
                            ...
                            <div className="hidden sm:block border-b-0 border-gray-200 dark:border-white/10">
                              <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist"> 
                                <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" 
                                    Id="hs-tab-to-select-item-1" Tab="#hs-tab-to-select-1" Controls="hs-tab-to-select-1">
                                  Tab 1
                                </SpkButton>
                                <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" 
                                    Id="hs-tab-to-select-item-2" Tab="#hs-tab-to-select-2" Controls="hs-tab-to-select-2">
                                  Tab 2
                                </SpkButton>
                                <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" 
                                    Id="hs-tab-to-select-item-3" Tab="#hs-tab-to-select-3" Controls="hs-tab-to-select-3">
                                  Tab 3
                                </SpkButton>
                              </nav>
                            </div>
                            ...
                            <div className="">
                              <div 
                                  id="hs-tab-to-select-1" role="tabpanel" aria-labelledby="hs-tab-to-select-item-1">
                              ...
                              <div 
                                  id="hs-tab-to-select-2" className="hidden" role="tabpanel" aria-labelledby="hs-tab-to-select-item-2">
                                <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-sm  sm:rounded-ss-none dark:border-white/10 border-gray-200">
                                  How travel coupons make you a better lover. Why cultural solutions are the new black. Why mom was right about travel insurances. How family trip ideas can help you predict the future. How carnival cruises make you a better lover. Why you'll never succeed at daily deals. 11 ways cheapest flights can find you the love of your life. The complete beginner's guide to mission trips. If you read one article about cultural notes read this one. Why you shouldn't eat vacation package in bed.
                                </p>
                              </div>
                              <div 
                                  id="hs-tab-to-select-3" className="hidden" role="tabpanel" aria-labelledby="hs-tab-to-select-item-3">
                                <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-sm  sm:rounded-ss-none dark:border-white/10 border-gray-200">
                                  Unbelievable healthy snack success stories. 12 facts about safe food handling tips that will impress your friends. Restaurant weeks by the numbers. Will mexican food ever rule the world? The 10 best thai restaurant youtube videos. How restaurant weeks can make you sick. The complete beginner's guide to cooking healthy food. Unbelievable food stamp success stories. How whole foods markets are making the world a better place. 16 things that won't happen in dish reviews.
                                </p>
                              </div>
                            ...
                            <div className="sm:border-b border-gray-200 dark:border-white/10">
                              <nav className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                                <SpkButton buttontype="button" customClass="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active" 
                                   Id="tabs-with-badges-item-1" Tab="#tabs-with-badges-1" Controls="tabs-with-badges-1">
                          ...
                          <div className="box-body">
                            <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 dark:hs-tab-active:bg-light dark:hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" 
                                Id="pills-on-gray-color-item-1" Tab="#pills-on-gray-color-1" Controls="pills-on-gray-color-1">
                                Tab 1
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 dark:hs-tab-active:bg-light dark:hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="pills-on-gray-color-item-2" Tab="#pills-on-gray-color-2" Controls="pills-on-gray-color-2">
                                Tab 2
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 dark:hs-tab-active:bg-light dark:hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="pills-on-gray-color-item-3" Tab="#pills-on-gray-color-3" Controls="pills-on-gray-color-3">
                                Tab 3
                              </SpkButton>
                            </nav>
                  ...
                  <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
                      <div className="box">
                          ...
                          <div className="box-body">
                            <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" 
                                Id="pills-with-brand-color-item-1" Tab="#pills-with-brand-color-1" Controls="pills-with-brand-color-1">
                                Tab 1
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="pills-with-brand-color-item-2" Tab="#pills-with-brand-color-2" Controls="pills-with-brand-color-2">
                                Tab 2
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="pills-with-brand-color-item-3" Tab="#pills-with-brand-color-3" Controls="pills-with-brand-color-3">
                                Tab 3
                              </SpkButton>
                            </nav>
                          ...
                          <div className="box-body">
                            <nav className="sm:flex sm:space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                              <SpkButton buttontype="button" customClass="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" 
                                Id="fill-and-justify-item-1" Tab="#fill-and-justify-1" Controls="fill-and-justify-1">
                                Tab 1
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="fill-and-justify-item-2" Tab="#fill-and-justify-2" Controls="fill-and-justify-2">
                                This is the longest link I've seen
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="fill-and-justify-item-3" Tab="#fill-and-justify-3" Controls="fill-and-justify-3">
                                Tab 3
                              </SpkButton>
                            </nav>
                          ...
                          <div className="box-body">
                            <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" 
                                Id="equal-width-elements-item-1" Tab="#equal-width-elements-1" Controls="equal-width-elements-1">
                                Tab 1
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="equal-width-elements-item-2" Tab="#equal-width-elements-2" Controls="equal-width-elements-2">
                                This is the longest link I've seen
                              </SpkButton>
                              <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" 
                                Id="equal-width-elements-item-3" Tab="#equal-width-elements-3" Controls="equal-width-elements-3">
                                Tab 3
                              </SpkButton>
                            </nav>
                            ...
                            <div className="border-b border-gray-200 dark:border-white/10">
                              <nav className="-mb-0.5 flex justify-center space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                                <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active" 
                                  Id="horizontal-alignment-item-1" Tab="#horizontal-alignment-1" Controls="horizontal-alignment-1">
                                  Tab 1
                                </SpkButton>
                                <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" 
                          ...
                          <div className="box-body">
                            <div className="border-b border-gray-200 dark:border-white/10">
                              <nav className="-mb-0.5 flex justify-end space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                                <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active" 
                                  Id="horizontal-right-alignment-item-1" Tab="#horizontal-right-alignment-1" Controls="horizontal-right-alignment-1">
                                  Tab 1
                                </SpkButton>
                                <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" 
