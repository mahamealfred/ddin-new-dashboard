                        ...
                        <div className={`box ${isFullscreen ? "box-fullscreen" : ""}`}>
                            <div className="box-body !p-0">
                                <div className="p-4 terms-heading-cover sm:flex items-center text-white bg-primary h5  rounded-t-md font-semibold mb-0">
                                    ...
                                    <Link aria-label="anchor" to="#"  className="ms-auto text-white terms-fullscreen" onClick={handleFullscreenClick} >
                            ...
                            <div className="box-footer md:flex block items-center justify-between shadow-lg !border-t-0">
                                ...
                                <div className="btn-list sm:mt-0 mt-2">
                                    <SpkButton buttontype="button" variant="outline-danger" customClass="ti-btn me-2">DECLINE</SpkButton>
                                    <SpkButton buttontype="button" variant="primary-full" customClass="ti-btn">ACCEPT</SpkButton>
                                </div>
                            </div>
                        </div>
                    </div>
