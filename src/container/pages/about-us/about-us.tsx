...
const AboutUs: FC<AboutUsProps> = () =>{ 
  interface team {
    ...
    const Teamdata: team[] = [
        { id: 1, src: face4, name: 'Samantha Taylor', mail: 'samantha2145@gmail.com' },
                        ...
                        <div className="grid grid-cols-12 sm:gap-x-6">
                            <div className="xxl:col-span-6 xl:col-span-6 col-span-12">
                                <div className="p-4 lg:p-0 text-start mb-6">
                                    ...
                                    <SpkButton buttontype="button" customClass="ti-btn bg-success text-white">Get Started</SpkButton>
                                </div>
                            </div>
                                    ...
                                    <div className="xxxl:col-span-3 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12" key={Math.random()}>
                                        <div className="box text-center">
                                            ...
                                            <div className="box-footer">
                                                <div>
                                                    <SpkButton Label="button" buttontype="button" variant="primary" Size="sm" customClass="ti-btn !me-[0.375rem]">
                                                        <i className="ri-facebook-line"></i>
                                                    </SpkButton>
                                                    <SpkButton Label="button" buttontype="button" variant="secondary" Size="sm" customClass="ti-btn !me-[0.375rem]">
                                                        <i className="ri-twitter-x-line"></i>
                                                    </SpkButton>
                                                    <SpkButton Label="button" buttontype="button" variant="warning" Size="sm" customClass="ti-btn">
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="text-center">
                                ...
                                <div className="input-group">
                                    ...
                                    <SpkButton customClass="ti-btn bg-success text-white !py-2 !px-[0.85rem] !rounded-s-none !mb-0" buttontype="button" Id="button-addon2">Send</SpkButton>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12"></div>
