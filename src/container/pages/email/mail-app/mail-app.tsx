...
import { Imagesdata, Mails, Mails1 } from '../../../../components/ui/data/pages/mail/mailappdata'
    ...
    return (
        <Fragment>
            ...
            <div className="container-fluid">
                <div className="main-mail-container !pb-2 gap-x-2 flex">
                                ...
                                <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
                                    <div className="ti-modal-content">
                                        <div className="ti-modal-header">
                                            ...
                                            <SpkButton buttontype="button" customClass="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor dark:!text-defaulttextcolor/70" Overlay="#todo-compose">
                                        ...
                                        <div className="ti-modal-body px-4">
                                            <div className="grid grid-cols-12 gap-6">
                                                ...
                                                <div className="xl:col-span-6 col-span-12 mb-2">
                                                    ...
                                                    <SelectComponent option={Selectoption2} placeholder='Select' mainClass="js-example-basic-multiple w-full" multi={true} searchable={true} defaultvalue={[Selectoption2[0]]}/>
                                                </div>
                                                <div className="xl:col-span-6 col-span-12 mb-2">
                                        ...
                                        <div className="ti-modal-footer">
                                            <SpkButton buttontype="button" variant="secondary-full"
                    ...
                    <div className={`total-mails ${isTotalMailsVisible ? '!block' : ''} ${isTotalMailsHidden ? '!hidden' : ''} border dark:border-defaultborder/10`}>
                        <div className="!p-4 flex items-center border-b dark:border-defaultborder/10">
                            ...
                            <SpkButton onclickfunc={() => Toggle1()} Label="button" buttontype="button" variant="light" customClass="ti-btn ti-btn-icon me-1 lg:!hidden block total-mails-close !mb-0">
                                <i className="ri-close-line"></i>
                            </SpkButton>
                            <SpkDropdown Icon={true} Customclass="ms-2" Linktag={false}  arialexpand={false} IconClass="ti ti-dots-vertical"
                                CustomToggleclass="!w-[2.313rem] !h-[2.313rem]  rounded-sm ti-btn-icon ti-btn-light">
                        ...
                        <div className="p-4">
                            <div className="input-group">
                                ...
                                <SpkButton Label="button" variant="light" customClass="ti-btn !rounded-s-none !mb-0" buttontype="button" Id="button-addon2"><i className="ri-search-line text-[#8c9097] dark:text-white/50"></i></SpkButton>
                            </div>
                        </div>
                        <SimpleBar>
                                                    ...
                                                    <p className="mail-msg mb-0">
                                                        ...
                                                        <span
                                                            ...
                                                            <SpkButton Label="button" buttontype="button"
                                                                customClass={`btn p-0 leading-none mail-starred ${idx.star} border-0 ltr:float-right rtl:float-left`}>
                    ...
                    <div className={`mails-information ${isMailsInformationVisible ? '!block' : ''} border dark:border-defaultborder/10 text-defaulttextcolor text-defaultsize`}
                        ...
                        <div className="mail-info-header flex flex-wrap gap-2 items-center">
                            ...
                            <div className="mail-action-icons">
                                <SpkOverlay>
                                    <SpkButton variant="light" buttontype="button" customClass="hs-tooltip-toggle ti-btn ti-btn-icon me-2">
                                ...
                                <SpkOverlay>
                                    <SpkButton variant="light" buttontype="button" customClass="hs-tooltip-toggle ti-btn ti-btn-icon">
                            ...
                            <SpkDropdown Icon={true} Customclass="hidden me-1" Linktag={false}  arialexpand={false} IconClass="ti ti-dots-vertical"
                                ...
                                <SpkButton onclickfunc={() => Close()} Label="button" buttontype="button" variant="light" customClass="ti-btn ti-btn-icon ms-1">
                                    <i className="ri-close-line"></i>
                                </SpkButton>
                            </div>
                        </div>
                        ...
                        <div className="mail-info-body  dark:!border-defaultborder/10 p-6 overflow-scroll" id="mail-info-body">
                            ...
                            <div className="mail-attachments mb-6">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div>
                                        <SpkButton buttontype="button" variant="success" customClass="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium">Download All</SpkButton>
                                    </div>
                                </div>
                                <div className="mt-2 flex items-center flex-wrap">
                                    <Link to="#"  className="mail-attachment border dark:!border-defaultborder/10 mb-1 me-2">
                                    ...
                                    <Link to="#"  className="mail-attachment border dark:!border-defaultborder/10">
                                    ...
                                    <SpkOverlay>
                                            <SpkButton variant="outline-light" buttontype="button" customClass="hs-tooltip-toggle !w-[2.75rem] !h-[2.75rem] ti-btn-icon dark:hover:!bg-light 
                        ...
                        <div className="mail-info-footer  dark:!border-defaultborder/10 flex flex-wrap gap-2 items-center justify-between">
                            <div className='flex flex-wrap gap-2'>
                                <SpkOverlay>
                                    <SpkButton buttontype="button" variant="light" customClass="hs-tooltip-toggle ti-btn ti-btn-icon">
                            ...
                            <div className="space-x-2 rtl:space-x-reverse">
                                ...
                                <SpkButton buttontype="button" variant="danger-full" customClass="ti-btn ms-1">
                    ...
                    <div className="mail-recepients border dark:border-defaultborder/10">
                        <div className="p-4 border-b  dark:border-defaultborder/10">
                            <SpkOverlay customClass="!ms-0">
                                <SpkButton Label="anchor" buttontype="button" customClass="hs-tooltip-toggle ti-btn ti-btn-light ti-btn-icon !rounded-full" ><i className="ri-add-line"></i>
                                    <span
                                        className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm dark:bg-slate-700"
                                        role="tooltip">
                                        Add Recepient
                        ...
                        <div className="p-4 flex flex-column items-center total-mail-recepients overflow-scroll" id="mail-recepients">
                            {Imagesdata.map((idx)=>(
                            <SpkOverlay customClass="[--placement:left]" key={Math.random()}>
