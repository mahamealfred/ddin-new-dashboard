...
import { Accountoptions, Countryoptions, Languageoptions, Mailsettingslist, MaxLimitoptions, Maximumoptions, } from '../../../../components/ui/data/pages/mail/mailsettingdata'
                        ...
                        <div className="box">
                                        ...
                                        <div className="sm:p-4 p-0">
                                            ...
                                            <div className="mb-6 sm:flex items-center">
                                                <div className="mb-0 me-[3rem]"> 
                                                    <span className="avatar avatar-xxl avatar-rounded">
                                                        ...
                                                        <SpkBadge variant="primary" aria-label="anchor" customClass="rounded-full avatar-badge">
                                                            ...
                                                            <i className="fe fe-camera !text-[0.65rem] !text-white" onClick={openFileInput}></i>
                                                        </SpkBadge>
                                                    </span>
                                                </div>
                                                <div className="inline-flex">
                                                    <SpkButton buttontype="button" customClass="ti-btn bg-primary text-white !rounded-e-none !font-medium">Change</SpkButton>
                                                    <SpkButton buttontype="button" variant="light" customClass="ti-btn !font-medium !rounded-s-none">Remove</SpkButton>
                                                </div>
                                            </div>
                                            <h6 className="font-semibold mb-4 text-[1rem]">
                                                Profile :
                                            ...
                                            <div className="sm:grid grid-cols-12 gap-6 mb-6">
                                                ...
                                                <div className="xl:col-span-6 col-span-12">
                                                    ...
                                                    <SelectComponent option={Languageoptions} mainClass="" multi={true} searchable={true} defaultvalue={[Languageoptions[0]]}/>
                                                </div>
                                                <div className="xl:col-span-6 col-span-12">
                                                    <label className="form-label">Country :</label>
                                                    <SelectComponent option={Countryoptions} mainClass="w-full !rounded-md" defaultvalue={[Countryoptions[0]]}/>
                                                </div>
                                                <div className="xl:col-span-12 col-span-12">
                                                ...
                                                <div className="box shadow-none mb-0 border dark:border-defaultborder/10">
                                                    <div className="box-header justify-between items-center sm:flex block">
                                                        ...
                                                        <div className="sm:mt-0">
                                                            <SpkButton buttontype="button" customClass="ti-btn !py-1 !px-2 bg-primary text-white !text-[0.75rem] !font-medium">Signout from all devices</SpkButton>
                                                        </div>
                                                    </div>
                                                    <div className="box-body">
                                                            ...
                                                            {Mailsettingslist.map((idx) => (
                                                                ...
                                                                <li className="list-group-item" key={Math.random()}>
                                                                    <div className="sm:flex block items-center">
                                                                        ...
                                                                        <SpkDropdown Icon={true} Customclass="" Linktag={true}  arialexpand={false}  IconClass="fe fe-more-vertical text-[0.8rem]"
                                        ...
                                        <ul className="list-group list-group-flush">
                                            ...
                                            <li className="list-group-item !border-e-0 !border-s-0">
                                                <div className="grid grid-cols-12 gap-4">
                                                    ...
                                                    <div className="xl:col-span-4 col-span-12">
                                                        ...
                                                        <SelectComponent multi option={Languageoptions} mainClass="w-full !rounded-md" defaultvalue={[Languageoptions[0], Languageoptions[1]]}/>
                                                    </div>
                                                    <div className="xl:col-span-5 col-span-12">
                                                        <div className="custom-toggle-switch ltr:sm:float-right rtl:sm:float-left">
                                            ...
                                            <li className="list-group-item !border-e-0 !border-s-0">
                                                <div className="grid grid-cols-12 gap-4">
                                                    ...
                                                    <div className="xl:col-span-4 col-span-12">
                                                        <SelectComponent option={Maximumoptions} mainClass="w-full !rounded-md" defaultvalue={[Maximumoptions[0]]}/>
                                                    </div>
                                                    <div className="xl:col-span-5 col-span-12">
                                                        <div className="custom-toggle-switch ltr:sm:float-right rtl:sm:float-left">
                                                ...
                                                <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-4">
                                                    ...
                                                    <div className="xl:col-span-8 col-span-12">
                                                        <div className="sm:flex block items-center justify-between sm:mt-0 mt-4">
                                                            ...
                                                            <div>
                                                                <SelectComponent option={MaxLimitoptions} mainClass="w-full !rounded-md" defaultvalue={[MaxLimitoptions[0]]}/>
                                                            </div>
                                                        </div>
                                                        <div className="sm:flex block items-center justify-between mt-4">
                                                            ...
                                                            <div>
                                                                 <SelectComponent option={Accountoptions} mainClass="w-full !rounded-md" defaultvalue={[Accountoptions[0]]}/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div className="box-footer">
                                <div className="ltr:float-right rtl:float-left">
                                    <SpkButton buttontype="button" variant="light" customClass="ti-btn  m-1">
                                        Restore Defaults
                                    </SpkButton>
                                    <SpkButton buttontype="button" customClass="ti-btn bg-primary text-white m-1">
                                        Save Changes
                                    </SpkButton>
                                </div>
                            </div>
