                        ...
                        <div className="box-body !p-0">
                            <div className="contact-page-banner">
                                <div className="text-center">
                                    ...
                                    <h6 className="text-[1rem] text-white mb-4 sm:px-0 px-3">Have any questions ? We would love to hear from you. </h6>
                                    <SpkButton buttontype="button" customClass="ti-btn bg-success text-white !font-medium">Contact <i className="ri-phone-line align-middle"></i></SpkButton>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                            <div className="box contactus-form overflow-hidden">
                                ...
                                <div className="box-footer">
                                    <div className="text-center">
                                        <SpkButton buttontype="button" variant="primary" customClass="ti-btn !font-medium">Send Message</SpkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
