                    ...
                    <div className="box">
                        <div className="box-header xxl:!flex !block">
                            ...
                            <div className="ms-auto xxl:!mt-0 !mt-2">
                                <SpkButton buttontype="button" customClass="ti-btn !py-1 !px-2 bg-primary text-white !text-[0.75rem] me-2">Save As PDF<i className="ri-file-pdf-line ms-1 align-middle inline-block"></i></SpkButton>
                                <SpkButton Label="button" buttontype="button" variant="secondary" Size="sm" customClass="ti-btn ti-btn-sm me-2"><i className="bi bi-plus-lg"></i></SpkButton>
                                <SpkButton Label="button" buttontype="button" variant="success" Size="sm" customClass="ti-btn ti-btn-sm me-2"><i className="bi bi-download"></i></SpkButton>
                            </div>
                        </div>
                        <div className="box-body">
                            <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                                        ...
                                        <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12 sm:mt-0 mt-4">
                                            ...
                                            <div className="grid grid-cols-12 gap-2">
                                                ...
                                                <div className="xl:col-span-12 col-span-12 choices-control">
                                                    ...
                                                    <SelectComponent option={Currencyoptions} mainClass="w-full !rounded-md !bg-light" placeholder='Select Currency'/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="xl:col-span-3 col-span-12">
                                    ...
                                    <SpkFlatpickr placeholder='Choose date' inputClass=" form-control-light ti-form-input !rounded-md bg-light" options={{ dateFormat: "Y-m-d" }}
                                        onfunChange={handleDateChange} />
                                </div>
                                <div className="xl:col-span-3 col-span-12">
                                    <label htmlFor="invoice-date-due" className="form-label">Due Date</label>
                                    <SpkFlatpickr placeholder='Choose date' inputClass=" form-control-light ti-form-input !rounded-md bg-light" options={{ dateFormat: "Y-m-d" }}  onfunChange={handleDateChange1} />
                                </div> 
                                <div className="xl:col-span-3 col-span-12">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table whitespace-nowrap border dark:border-defaultborder/10 mt-3">
                                            ...
                                            <tbody>
                                                <tr className="border border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td className="invoice-quantity-container">
                                                        <div className="input-group dark:border-defaultborder/10 rounded-md !flex-nowrap">
                                                            <SpkButton Label="button" buttontype="button" variant="" customClass="ti-btn ti-btn-icon !bg-primary !text-white input-group-text !mb-0 product-quantity-minus !rounded-e-none" onclickfunc={dec}><i className="ri-subtract-line"></i></SpkButton>
                                                            <input type="number" className="form-control  text-center !w-12 !p-1" aria-label="quantity" id="product-quantity4" defaultValue="1" />
                                                            <SpkButton Label="button" buttontype="button" variant="" customClass="ti-btn ti-btn-icon !bg-primary !text-white input-group-text !mb-0 product-quantity-plus !rounded-s-none" onclickfunc={inc}><i className="ri-add-line"></i></SpkButton>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <SpkButton Label="button" buttontype="button" variant="danger" Size="sm" customClass="ti-btn ti-btn-icon"><i className="ri-delete-bin-5-line"></i></SpkButton>
                                                    </td>
                                                </tr>
                                                <tr className="border border-defaultborder dark:border-defaultborder/10">
                                                    <td>
                                                    ...
                                                    <td className="invoice-quantity-container">
                                                        <div className="input-group dark:border-defaultborder/10 rounded-md  !flex-nowrap">
                                                            <SpkButton Label="button" buttontype="button" variant="" customClass="ti-btn ti-btn-icon !bg-primary !text-white input-group-text flex-fill !mb-0 product-quantity-minus !rounded-e-none" onclickfunc={dec}><i className="ri-subtract-line"></i></SpkButton>
                                                            <input type="number" className="form-control  text-center !w-12 !p-1" aria-label="quantity" id="product-quantity5" defaultValue="1" />
                                                            <SpkButton Label="button" buttontype="button" variant="" customClass="ti-btn ti-btn-icon !bg-primary !text-white input-group-text flex-fill !mb-0 product-quantity-plus !rounded-s-none" onclickfunc={inc}><i className="ri-add-line"></i></SpkButton>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colSpan={6} className="border-bottom-0"><Link className="ti-btn ti-btn-light !font-medium" to="#" ><i className="bi bi-plus-lg"></i> Add Product</Link></td>
                                                </tr>
                                                <tr>
                                                    <td colSpan={4}></td>
                                                    <td colSpan={2}>
                        ...
                        <div className="box-footer text-end">
                            <SpkButton buttontype="button" variant="light" customClass="ti-btn sm:me-2 !mb-2 sm:!mb-0 "><i className="ri-eye-line me-1 align-middle inline-block"></i>Preview</SpkButton>
                            <SpkButton buttontype="button" variant="" customClass="ti-btn bg-primary text-white !mb-0">Send Invoice <i className="ri-send-plane-2-line ms-1 align-middle inline-block"></i></SpkButton>
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    ...
                                    <label htmlFor="invoice-payment-cardname" className="form-label mb-0"><Link className="text-danger text-[0.6875rem]" to="#" >Enter valid card number*</Link></label>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
