...
import  { Manageinvoicedata, Voiceoptions, Voiceseries }from "../../../../components/ui/data/pages/invoice/invoicelistdata";
                ...
                <div className="xl:col-span-9 col-span-12">
                    <div className="box">
                        <div className="box-header justify-between">
                            ...
                            <div className="flex">
                                <SpkButton buttontype="button" customClass="ti-btn !py-1 !px-2 !text-[0.75rem] !text-white !font-medium bg-primary"><i className="ri-add-line font-semibold align-middle me-1"></i> Create Invoice</SpkButton>
                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <Spktables tableClass="table whitespace-nowrap table-bordered min-w-full" 
                                  header={[{ title: 'Client',headerClassname:'text-start' }, { title: 'Invoice ID' ,headerClassname:'text-start' }, { title: 'Issued Date',headerClassname:'text-start'  },
                                   { title: 'Amount' ,headerClassname:'text-start' }, { title: 'Status',headerClassname:'text-start'  }, { title: 'Due Date',headerClassname:'text-start'  }, { title: 'Action' ,headerClassname:'text-start' }]}>
                                        {manageInvoiceData.map((idx) => (
                                            <tr className="invoice-list border border-defaultborder dark:border-defaultborder/10" key={Math.random()}>
                                                ...
                                                <td>
                                                    <SpkBadge variant={`${idx.color}/10`} customClass={`text-${idx.color}`}>{idx.badge}</SpkBadge>
                                                </td>
                                                <td>
                                                    {idx.due}
                                                </td>
                                                <td>
                                                    <SpkButton Label="button" buttontype="button" variant="primary" Size="sm" customClass="ti-btn ti-btn-icon me-2"><i className="ri-printer-line"></i></SpkButton>
                                                    <SpkButton onclickfunc={() => handleDelete(idx.id)} Label="button" variant="danger" buttontype="button" Size="sm" customClass="ti-btn ti-btn-icon ms-1 invoice-btn" ><i className="ri-delete-bin-5-line"></i></SpkButton>
                                                </td>
                                            </tr>
                                        ))}
                                </Spktables>
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                                ...
                                <div className="flex-grow">
                                    <h6 className="mb-1 !text-[0.75rem] !font-medium">Overdue Invoices
                                        <SpkBadge variant="light" customClass="text-default font-semibold ltr:float-right rtl:float-left">
                                            1,105
                                        </SpkBadge>
                                    </h6>
                                    <div>
                            ...
                            <div className="p-6">
                                ...
                                <div id="invoice-list-stats">
                                    <ApexchartsComponent chartOptions={Voiceoptions} chartSeries={Voiceseries} type="bar" height={210}  />
                                </div>
                            </div>
                        </div>
                    </div>
