                    ...
                    <div className="box">
                        <div className="box-header md:flex block">
                            ...
                            <div className="ms-auto md:mt-0 mt-2">
                                <SpkButton buttontype="button" customClass="ti-btn !py-1 !px-2  text-white !text-[0.75rem] bg-secondary me-2" onclickfunc={() => print()}>Print<i className="ri-printer-line ms-1 align-middle inline-block"></i></SpkButton>
                                <SpkButton buttontype="button" customClass="ti-btn !py-1 !px-2 text-white !text-[0.75rem] bg-primary">Save As PDF<i className="ri-file-pdf-line ms-1 align-middle inline-block"></i></SpkButton>
                            </div>
                        </div>
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                                        <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12">
                                            ...
                                            <p className="text-[#8c9097] dark:text-white/50">For more information check for <Link to="#" className="text-primary font-semibold"><u>GSTIN</u></Link> Details.</p>
                                        </div>
                        ...
                        <div className="box-footer text-end">
                            <SpkButton buttontype="button" customClass="ti-btn bg-success text-white">Download <i className="ri-download-2-line ms-1 align-middle"></i></SpkButton>
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 gap-4">
                                <div className="xl:col-span-12 col-span-12">
                                    ...
                                    <p className="mb-4">
                                        <span className="font-semibold text-[#8c9097] dark:text-white/50 text-[0.75rem]">Invoice Status : <SpkBadge variant="warning/10" customClass="text-warning">Pending</SpkBadge></span>
                                    </p>
