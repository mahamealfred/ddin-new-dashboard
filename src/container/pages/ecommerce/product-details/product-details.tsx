...
import { productdetailstable } from '../../../../components/ui/data/pages/ecommerces/editproductsdata';
import SpkButton from '../../../../@spk/uielements/spk-button';


interface ProductdetailsProps {}

const Productdetails: FC<ProductdetailsProps> = ({ local_varaiable,   }:any) => {
    ...
    useEffect(() => {
        if (id) {
            const data = local_varaiable.ecommercedata.filter((ele: any) => ele.id === id);
            setDefaultData(data[0]);
        } else {
            setDefaultData({
                id: Math.random(),
                preview: ecommerceimg15,
                images: [
                    { img: ecommerceimg15 },
                    { img: ecommerceimg13 },
                    { img: ecommerceimg14 },
                                    ...
                                    <div className="sm:grid grid-cols-12 !gap-x-6 md:me-[1rem] ">
                                        <div className="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 md:mb-[3rem] mb-4">
                                                ...
                                                >
                                                    ...
                                                    <img 
                                                        className={defaultData?.preview !== ecommerceimg15 ? "img-fluid mx-auto d-block" : ""} 
                                                        src={defaultData?.preview} 
                                                        alt="img" 
                                                    />  
                                                    </SwiperSlide>
                                                </Swiper>
                                                ...
                                                >
                                                    {defaultData?.images.map((ele: any) => (
                                                        <SwiperSlide key={ele.img} onClick={() => setDefaultData({ ...defaultData, preview: ele.img })}>
                                        ...
                                        <div className="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 md:block hidden">
                                            ...
                                            <div className="table-responsive">
                                                <Spktables tableClass="table table-bordered whitespace-nowrap min-w-full">
                                                        {productdetailstable.map((idx)=>(
                                                            <tr key={ Math.random()}>
                                                                <td>
                                                                    <Link to="#" >
                                                                        <div className="flex items-start">
                                                                            ...
                                                                            <div className="flex-grow">
                                                                                <p className="mb-1 text-[0.875rem] font-semibold similar-product-name text-truncate">{idx.title}</p>
                                                                                <p className="mb-0">
                                                                                    <SpkBadge variant="success" customClass="text-white">{idx.rating}<i className="ri-star-s-fill ms-1"></i></SpkBadge>
                                                                                    <span className="text-[#8c9097] dark:text-white/50 ms-1">({idx.views})</span>
                                                                                </p>
                                                                            </div>
                                                        ...
                                                        <tr>
                                                            <td className="grid">
                                                                <SpkButton variant="primary" buttontype="button" customClass="ti-btn !font-medium">View All Products</SpkButton>
                                                            </td>
                                                        </tr>
                                                </Spktables>
                                            </div>
                                    ...
                                    <div className="md:grid grid-cols-12 gap-x-[3rem]">
                                        <div className="xl:col-span-8 col-span-12 xxl:mt-0 mt-4">
                                            ...
                                            <p className="text-[1.125rem] mb-4">
                                                ...
                                                <span className="font-semibold text-[#8c9097] dark:text-white/50 ms-1">4.3<Link className="text-info" to="#" >(2.4k Reviews)</Link></span>
                                            </p>
                                                ...
                                                <div className="grid grid-cols-12 gap-x-6">
                                                    <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                                        ...
                                                        <p className="mb-0 flex">
                                                            <Link aria-label="anchor" className="color-1 product-colors selected" to="#" >
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-2 product-colors" to="#" >
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-3 product-colors" to="#" >
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-4 product-colors" to="#" >
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                            <Link aria-label="anchor" className="color-5 product-colors" to="#" >
                                                                <i className="ri-checkbox-blank-circle-fill"></i>
                                                            </Link>
                                                        </p>
                                                    </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="table-responsive min-w-full">
                                                    <Spktables tableClass="table table-bordered whitespace-nowrap w-full">
                                                        ...
                                                        <div className="border p-4 dark:border-defaultborder/10">
                                                            <div className="sm:flex block items-start mb-4">
                                                                ...
                                                                <div className="sm:ps-0 sm:mt-0 mt-4 ps-2">
                                                                    <SpkBadge variant="success" customClass="text-white">Verified Purchase</SpkBadge>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="product-images sm:!ps-4 !ps-0">
                                                                <div className="sm:grid grid-cols-12 gap-6">
                                                                    ...
                                                                    <div className="xl:col-span-6 col-span-12 flex items-end sm:justify-end sm:mt-0 mt-2">
                                                                        <SpkButton buttontype="button" variant="light" customClass="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium me-2 whitespace-nowrap">Report abuse</SpkButton>
                                                                        <SpkButton Label="button" buttontype="button" variant="primary" Size="sm" customClass="ti-btn me-2">
                                            ...
                                            <div className="mb-[3rem]">
                                                <div className="offer-promotion dark:border-defaultborder/10 mb-6">
                                                    <div className="xxl:flex flex lg:block sm:flex flex-wrap justify-between items-center">
                                                        <div className="text-warning xxxl:mb-0 mb-2">Use Code <span className="promotion-code font-semibold">FIRBUY</span><Link className="text-[.625rem] text-warning ms-1" to="#" >T&amp;C.</Link></div>
                                                    ...
                                                    <ul className="list-group">
                                                        ...
                                                        <li className="list-group-item">
                                                            <div className="text-[0.75rem] text-default">
                                                                <span className="text-success me-1 font-semibold">Bank Offer:</span><span className="flex-grow">5% off upto 500 on min purchase of $999<Link to="#"  className="text-primary ms-1">View.</Link></span>
                                                            </div>
                                                        </li>
                                                        <li className="list-group-item">
                                                            <div className="text-[0.75rem] text-default">
                                                                <span className="text-success me-1 font-semibold">Emi:</span><span className="flex-grow">No cost emi on selected bank card on min purchase of $1,499<Link to="#"  className="text-primary ms-1">View.</Link></span>
                                                            </div>
                                                        </li>
                                                            ...
                                                            <ul className="list-group" id="offers-more">
                                                                <li className="list-group-item border-0 border-b">
                                                                    <div className="text-[0.75rem] text-defaulttextcolor">
                                                                        <span className="text-success me-1 font-semibold">Free Delivery:</span><span className="flex-grow">Free delivery on first order<Link to="#"  className="text-primary ms-1">View.</Link></span>
                                                                    </div>
                                                                </li>
                                                                <li className="list-group-item border-0 !border-b-0">
                                                                    <div className="text-[0.75rem] text-default">
                                                                        <span className="text-success me-1 font-semibold">Promotion:</span><span className="flex-grow">Offer upto 30% on grosery on purchase of this item<Link to="#"  className="text-primary ms-1">T&amp;C.</Link></span>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li className="list-group-item border-t-0">
                                                            <Link className="text-success text-[0.75rem] hs-collapse-toggle inline-flex items-center gap-x-2" to="#"  id="hs-show-hide-collapse" data-hs-collapse="#hs-show-hide-collapse-heading"><u>More Offers</u>
                                                            </Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="mb-4">
                                                    ...
                                                    <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50">Min 7 days return and exchange policy. Return Policies may vary based on products and promotions. For full details on our Returns Policies, please <Link to="#"  className="text-primary">click here</Link>․</p>
                                                </div>
                                                <div className="alert alert-light mb-6 text-[0.75rem] text-[#8c9097] dark:text-white/50" role="alert">
                                                    <Link aria-label="anchor" to="#" ><i className="ri-map-pin-line me-1 align-middle text-primary text-[.9375rem] inline-block"></i></Link>Select location to find out estimated delivery date
                                                </div>
                                                <div className="grid gap-2">
                                                    <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/cart/`} className="ti-btn bg-primary !font-medium text-white">Add To Cart</Link>
                                                    <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/checkout/`} className="ti-btn bg-success !font-medium text-white">Buy Now</Link>
                                                    <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/wishlist/`} className="ti-btn bg-light !font-medium">Add To Wishlist</Link>
                                                </div>
                                            </div>
                                            <div className="text-center">
                                                <Link aria-label="anchor" to="#" >
                                                    <img src={ecommerceimg25} alt="" className="img-fluid rounded bg-light mx-auto" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
