                    ...
                    <div className="box">
                                ...
                                <table className="table whitespace-nowrap min-w-full">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mb-1">
                                                            <span className="me-1">Color:</span><span className="text-[#8c9097] dark:text-white/50">Grey
                                                            <SpkBadge variant="success" customClass="text-white ms-3">In Offer</SpkBadge></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mb-1">
                                                            <span className="me-1">Color:</span><span className="text-[#8c9097] dark:text-white/50">Orange
                                                            <SpkBadge variant="info" customClass="text-white bg- ms-3">32% Off</SpkBadge></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                                            ...
                                            <td>
                                                <SpkBadge variant="success/10" customClass="text-success">SPKFIR</SpkBadge>
                                            </td>
                                        </tr>
                                        <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                                            <td colSpan={2}></td>
                        ...
                        <div className="box-footer !border-t-0">
                            <div className="btn-list ltr:float-right rtl:float-left">
                                <SpkButton Label="button" buttontype="button" customClass="ti-btn bg-primary text-white !py-1 !px-2 !font-medium me-2" onclickfunc={() => print()}><i className="ri-printer-line me-1 align-middle inline-block"></i>Print</SpkButton>
                                <SpkButton Label="button" buttontype="button" customClass="ti-btn bg-secondary text-white !py-1 !px-2 !font-medium"><i className="ri-share-forward-line me-1 align-middle inline-block"></i>Share Details</SpkButton>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body !p-0">
                            <div className="flex items-center border-b border-dashed dark:border-defaultborder/10 p-3 flex-wrap">
                                ...
                                <div>
                                    <SpkBadge variant="primary/10" customClass="text-primary">Prime User</SpkBadge>
                                </div>
                            </div>
                            <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <SpkButton Label="button" buttontype="button" Size="sm" customClass="ti-btn bg-primary text-white"><i className="ri-pencil-line"></i></SpkButton>
                                </div>
                            ...
                            <div className="order-track">
                                <div className="hs-accordion-group" data-hs-accordion-always-open>
                                    <div className="hs-accordion active" id="order-heading-one">
                                        <Link to="#!"  className="hs-accordion-toggle group pb-3 inline-flex items-center gap-x-3 w-full font-semibold text-start transition"
                                        ...
                                        <div id="order-collapse-one" className="space-y-3 hs-accordion-content w-full overflow-hidden transition-[height] duration-300" aria-labelledby="order-heading-one">
                                            <div className="accordion-body !pt-0 !ps-8">
                                                <div className="text-[0.6875rem]">
                                                    <p className="mb-0 ps-4">Order placed successfully by <Link to="#"  className="font-weight-semibold text-primary">Sansa Taylor</Link></p>
                                    ...
                                    <div className="hs-accordion active" id="order-heading-three">
                                        <Link to="#!"  className="hs-accordion-toggle group pb-3 inline-flex items-center gap-x-3 w-full font-semibold text-start transition" aria-controls="order-collapse-three">
                                            <div className="flex mb-0">
                                                <div className="me-2">
                                                    <span className="avatar avatar-md avatar-rounded">
