...
import { ItemData1 } from '../../../../components/ui/data/pages/ecommerces/ecommercedata';
                    ...
                    <div className="box" id="cart-container-delete">
                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <Spktables tableClass="table table-bordered  min-w-full"
                                 header={[{ title: 'Product Name' , headerClassname:'text-start'}, { title: 'Price', headerClassname:'text-start' }, { title: 'Quantity' , headerClassname:'text-start'}, { title: 'Total' , headerClassname:'text-start'}, { title: 'Action', headerClassname:'text-start' }]}>
                                    {cart.map((idx) => (
                                            <tr className="border border-inherit border-solid dark:border-defaultborder/10"  key={Math.random()}>
                                                <td className="whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="mb-1 flex items-center align-middle">
                                                                <span className="me-1">Color:</span><span className="font-semibold text-[#8c9097] dark:text-white/50">Grey
                                                                <SpkBadge variant="success/10" customClass="text-success ms-4">In Offer</SpkBadge></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="product-quantity-container">
                                                    <div className="input-group dark:border-defaultborder/10 rounded-md !flex-nowrap">
                                                        <SpkButton onclickfunc={() => decrementQuantity(idx.id)} Label="button" buttontype="button" customClass="!border-0 ti-btn ti-btn-icon ti-btn-light  input-group-text flex-grow product-quantity-minus !mb-0" ><i className="ri-subtract-line"></i></SpkButton>
                                                        ...
                                                        <SpkButton onclickfunc={() => incrementQuantity(idx.id)} Label="button" buttontype="button" customClass="!border-0 ti-btn ti-btn-icon ti-btn-light input-group-text flex-grow product-quantity-plus !mb-0" ><i className="ri-add-line"></i></SpkButton>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="flex items-center">
                                                        <SpkOverlay customClass="ltr:[--placement:left] rtl:[--placement:right]">
                                                            <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/wishlist/`} type="button" className="hs-tooltip-toggle ti-btn ti-btn-icon bg-success text-white !font-medium me-1">
                                                        ...
                                                        <SpkOverlay customClass="ltr:[--placement:left] rtl:[--placement:right]">
                                                            <SpkButton buttontype="button"
                                                                onclickfunc={() => handleClick(idx.id)}
                                                                customClass="hs-tooltip-toggle ti-btn ti-btn-icon bg-danger text-white !font-medium btn-delete">
                    ...
                    <div className="box !hidden" id="cart-empty-cart">
                        ...
                        <div className="box-body flex items-center justify-center">
                            <div className="cart-empty text-center">
                                ...
                                <Link to="#"className="ti-btn bg-primary text-white !font-medium m-4" data-abc="true">continue shopping <i className="bi bi-arrow-right ms-1"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                                <div className="input-group mb-1">
                                    ...
                                    <SpkButton buttontype="button" customClass="ti-btn !bg-primary !text-white !font-medium !rounded-s-none !mb-0" id="coupons">Apply</SpkButton>
                                </div>
                                <Link to="#"  className="text-[0.75rem] text-success">10% off on first purchase</Link>
                            </div>
                            <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                            ...
                            <div className="p-4 grid">
                                <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/checkout/`} className="ti-btn bg-primary  text-white !font-medium !mb-2">Proceed To Checkout</Link>
                                <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/products/`} className="ti-btn bg-light  !font-medium">Continue Shopping</Link>
                            </div>
                        </div>
                    </div>
                </div>
