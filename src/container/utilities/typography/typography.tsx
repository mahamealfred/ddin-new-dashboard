...
import { typography1, typography2, typography3, typography4, typography5, typography6, typography7, typography8 } from '../../../components/prism-code/utilities-prism'
    ...
    <Fragment>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Heading tags" reactCode={typography1} customCardBodyClass="space-y-3">
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title=" Inline text elements" reactCode={typography2} customCardBodyClass="space-y-3">
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Description list alignment" reactCode={typography3} customCardBodyClass="space-y-3">
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="First-line and first-letter" reactCode={typography4} customCardBodyClass="space-y-8">
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Font Sizes" reactCode={typography5} customCardBodyClass="space-y-3">
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Open/closed state" reactCode={typography6} customCardBodyClass="space-y-8">
                        <div className="">
                    ...
                    <Showcode title="Text Decoration" reactCode={typography7} customCardBodyClass="space-y-3">
                    ...
                    <Showcode title="Text Transform" reactCode={typography8} customCardBodyClass="space-y-3">
