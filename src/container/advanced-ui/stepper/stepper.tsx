...
import { Stepper1, Stepper2, Stepper3, Stepper4, Stepper5, Stepper6 } from '../../../components/prism-code/advance-uiprism'
            ...
            <Pageheader currentpage="Stepper" activepage=" Advanced Ui" mainpage="Stepper" />
                <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                    <div className="col-span-12 xxl:col-span-6">
                            <Showcode title="Basic Stepper" reactCode={Stepper1}>
                                <div data-hs-stepper>
                                    ...
                                    <div className="mt-5 sm:mt-8">
                                        ...
                                        <div className="mt-5 sm:flex justify-between items-center gap-x-2">
                                            <SpkButton buttontype="button"
                                               variant="light"  customClass="ti-btn me-2 disabled:opacity-50 disabled:pointer-events-none"
                                               StepperBack={true}><i className="ri-arrow-left-s-line rtl:rotate-180"></i>
                                                Back</SpkButton>
                                            <SpkButton buttontype="button"
                                               variant="primary-full"  customClass="ti-btn me-2 disabled:opacity-50 disabled:pointer-events-none"
                                               Steppernext={true}>Next<i
                                                    className="ri-arrow-right-s-line rtl:rotate-180"></i></SpkButton>
                                            <SpkButton buttontype="button"
                                               variant="primary-full"  customClass="ti-btn me-2 disabled:opacity-50 disabled:pointer-events-none"
                                               Stepperfinish={true} 
                                               Btnstyle={{ display: "none" }}
                                                >Finish</SpkButton>
                                            <SpkButton buttontype="reset"
                                               variant="primary-full"  customClass="ti-btn disabled:opacity-50 disabled:pointer-events-none"
                                               Stepperreset={true}
                                               Btnstyle={{ display: "none" }}
                                                 >Reset</SpkButton>
                                        </div>
                    ...
                    <div className="col-span-12 xxl:col-span-6">
                            ...
                            <Showcode title="Non-linear Stepper" reactCode={Stepper2}>
                                <div data-hs-stepper='{"mode": "non-linear"}'>
                                    ...
                                    <div className="mt-5 sm:mt-8">
                                        ...
                                        <div className="mt-5 sm:flex justify-between items-center gap-x-2">
                                            <SpkButton buttontype="button"
                                                customClass="ti-btn me-2  ti-btn-light disabled:opacity-50 disabled:pointer-events-none"
                                                StepperBack={true}><i className="ri-arrow-left-s-line rtl:rotate-180"></i>
                                                Back</SpkButton>
                                            <SpkButton buttontype="button"
                                                customClass="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
                                                Stepperskip={true} 
                                                Btnstyle={{ display: "none" }}
                                                >Skip</SpkButton>
                                            <SpkButton buttontype="button"
                                                customClass="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
                                                Steppercomplete='{"completedText": "This step is completed"}'>Complete
                                                Step</SpkButton>
                                            <SpkButton buttontype="button"
                                                customClass="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
                                                Steppernext={true}>Next<i
                ...
                <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                    <div className="col-span-12 xxl:col-span-6">
                            ...
                            <Showcode title="Skipped Stepper" reactCode={Stepper3}>
                                <div data-hs-stepper>
                                    <ul className="relative sm:flex flex-row gap-x-2 sm:space-y-0 space-y-4">
                    ...
                    <div className="col-span-12 xxl:col-span-6">
                            ...
                            <Showcode title="Active Stepper" reactCode={Stepper4}>
                ...
                <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                    <div className="col-span-12 xxl:col-span-6">
                            ...
                            <Showcode title="Error Stepper" reactCode={Stepper5}>
                                <div data-hs-stepper='{"currentIndex": 2}'>
                                    <ul className="relative sm:flex flex-row gap-x-2 sm:space-y-0 space-y-4">
                                        <li className="flex items-center gap-x-2 shrink basis-0 flex-1 group success"
                                            data-hs-stepper-nav-item='{"index": 1,"isCompleted": true}'>
                    ...
                    <div className="col-span-12 xxl:col-span-6">
                            ...
                            <Showcode title="Success Stepper" reactCode={Stepper6}>
                                    ...
                                    <div className="mt-5 sm:mt-8">
                                        ...
                                        <div className="mt-5 sm:flex justify-between items-center gap-x-2">
                                            <SpkButton buttontype="button"
                                                ...
                                                Btnstyle={{ display: "none" }}
                                                ><i
                                                    className="ri-arrow-left-s-line rtl:rotate-180"></i> Back</SpkButton>
                                            <SpkButton buttontype="button"
                                                customClass="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
                                                Steppernext={true} 
                                                Btnstyle={{ display: "none" }}
                                            ...
                                            <SpkButton buttontype="reset"
                                                customClass="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none" 
                                                Stepperreset={true}>Reset</SpkButton>
                                        </div>
                                    </div>
                                </div>
                                </Showcode>
