                    ...
                    <div className="relative sm:flex sm:items-center">
                      <div className="flex items-center justify-between">
                        <Link to={`${import.meta.env.BASE_URL}dashboards/crm/`} className="header-logo">
                          <img src={toggledark} alt="logo" className="dark:hidden block"/>
                          <img src={toggledark} alt="logo" className="hidden dark:block"/>
                        </Link>
                        <div className="sm:hidden">
                          <SpkButton buttontype="button"
                            ...
                            Collapse="#navbar-basic-usage" Controls="navbar-basic-usage"
                      ...
                      <div id="navbar-basic-usage"
                        ...
                        <div
                          ...
                          <Link className="font-medium text-primary dark:focus:outline-none dark:focus:ring-0 dark:focus:ring-primary"
                            to="#" aria-current="page">Active</Link>
                          <div className="hs-dropdown [--strategy:static] sm:[--strategy:absolute] [--adaptive:none]">
                            <SpkButton buttontype="button"
                              customClass="flex items-center w-full text-gray-600 hover:text-gray-400 font-medium dark:text-white/70 dark:hover:text-white dark:focus:outline-none dark:focus:ring-0 dark:focus:ring-primary">
                              Mega Menu
                      ...
                      <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                        ...
                        <div
                          ...
                          <SpkButton Id="hs-mega-menu-basic-dr3" buttontype="button"
                            customClass="flex items-center w-full text-gray-600 hover:text-gray-400 font-medium dark:text-white/70 dark:hover:text-white/70 ">
                            Dropdown
                    ...
                    <div id="navbar-auto-close-behavior"
                      ...
                      <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                        ...
                        <div
                          ...
                          <SpkButton buttontype="button"
                            customClass="sm:py-4 flex items-center w-full text-gray-600 hover:text-gray-400 font-medium dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none">
                            Mega Menu
                            <svg className="ms-2 flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                              height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                              strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <div id="navbar-collapse-columns-1"
                        ...
                        <div
                          ...
                          <div
                            className="hs-dropdown [--strategy:static] sm:[--strategy:absolute] [--adaptive:none] sm:[--trigger:hover]">
                            <SpkButton buttontype="button"
                              customClass="sm:py-3 flex items-center w-full text-gray-600 hover:text-gray-400 font-medium dark:text-white/70 dark:hover:text-white dark:focus:outline-none dark:focus:ring-0 dark:focus:ring-primary">
                              1 Col
                    ...
                    <div id="navbar-with-mega-menu"
                      ...
                      <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                        ...
                        <div className="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none]">
                          <SpkButton Id="hs-mega-menu-basic-dr1" buttontype="button" customClass="flex items-center w-full text-gray-600 hover:text-gray-400 font-medium dark:text-white/70 dark:hover:text-gray-500">
                            Dropdown
                          ...
                          // style=""
                          >
                            <Link className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-primary dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" to="#" >
                              About
                            </Link>
                            <div className="hs-dropdown relative [--strategy:static] sm:[--strategy:absolute] [--adaptive:none] py-2 px-3">
                              <SpkButton buttontype="button" className="w-full flex justify-between items-center text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:ring-2 focus:ring-primary dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
              ...
              <div className="box-body space-y-4">
                <header
                  ...
                  <nav className="w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                    <div className="flex items-center justify-between">
                      <Link to="#"  className="header-logo">
                        <img src={togglewhite} alt="logo" className="block"/>
                      </Link>
                      <div className="sm:hidden">
                        <SpkButton buttontype="button"
                          ...
                          Collapse="#navbar-primary" Controls="navbar-primary"
                          Label="Toggle navigation">
                          <svg className="hs-collapse-open:hidden w-4 h-4" width="16" height="16" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path fillRule="evenodd"
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="sm:hidden">
                        <SpkButton buttontype="button"
                          ...
                          Collapse="#navbar-secondary" Controls="navbar-secondary"
                          Label="Toggle navigation">
                          <svg className="hs-collapse-open:hidden w-4 h-4" width="16" height="16" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path fillRule="evenodd"
