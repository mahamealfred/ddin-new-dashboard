            ...
            <div className="box-body">
              ...
              {!loading && !error && filteredData.length > 0 && (
                <>
                  ...
                  {/* Pagination - always visible, improved style */}
                  <div className="flex items-center justify-between px-4 py-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-b-xl shadow-inner">
