...
import { SignupSwiper } from '../../../../components/ui/data/authentication/swipercoverdata';
                ...
                <div className="grid grid-cols-12 gap-y-4">
                    ...
                    <div className="xl:col-span-12 col-span-12">
                        ...
                        <div className="input-group">
                            ...
                            <SpkButton Label="button" variant="light" customClass="ti-btn !rounded-s-none !mb-0" onclickfunc={()=>setpasswordshow1(!passwordshow1)} buttontype="button" Id="button-addon2"><i className={`${passwordshow1 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                        </div>
                    </div>
                    <div className="xl:col-span-12 col-span-12">
                        ...
                        <div className="input-group">
                            ...
                            <SpkButton Label="button" variant="light" customClass="ti-btn !rounded-s-none !mb-0" onclickfunc={()=>setpasswordshow2(!passwordshow2)} buttontype="button" Id="button-addon21"><i className={`${passwordshow2 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                        </div>
                        <div className="form-check mt-4 flex !ps-0 ">
                            ...
                            <label className="form-check-label text-[#8c9097] dark:text-white/50 font-normal flex-wrap" htmlFor="defaultCheck1">
                                By creating a account you agree to our <Link to={`${import.meta.env.BASE_URL}pages/terms-conditions/`} className="text-success"><u className='mx-1'>&nbsp;Terms &amp; Conditions</u></Link>&nbsp; and&nbsp; <Link to="#" className="text-success"><u className='mx-1'>Privacy Policy</u></Link>
                            </label>
                        </div>
                    </div>
                    <div className="xl:col-span-12 col-span-12 grid mt-1">
                        <SpkButton type="button" Size="lg" customClass="ti-btn bg-primary text-white !font-medium dark:border-defaultborder/10">Create Account</SpkButton>
                    </div>
                </div>
      ...
      <div className="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 xl:block hidden px-0">
          <div className="authentication-cover">
              <div className="aunthentication-cover-content rounded">
                  ...
                  <SwiperComponent slides={SignupSwiper} spaceBetween={30} navigation={true} centeredSlides={true} autoplay={true} pagination={true}  className="mySwiper"/>
                  </div>
              </div>
          </div>
      </div>
