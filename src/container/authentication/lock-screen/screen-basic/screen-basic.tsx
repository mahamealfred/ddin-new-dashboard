...
interface ScreenbasicProps {}

const Screenbasic: FC<ScreenbasicProps> = () => {
                      ...
                      <div className="grid grid-cols-12 gap-y-4">
                          <div className="xl:col-span-12 col-span-12 mb-2">
                              ...
                              <div className="input-group">
                                  ...
                                  <SpkButton onclickfunc={()=>setpasswordshow1(!passwordshow1)} Label="button" buttontype="button" customClass="ti-btn ti-btn-light !mb-0 !rounded-s-none" Id="button-addon2"><i className={`${passwordshow1 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                              </div>
                              <div className="mt-4">
