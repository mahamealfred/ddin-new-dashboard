...
import { ResetSwiper } from '../../../../components/ui/data/authentication/swipercoverdata';
                        ...
                        <div className="grid grid-cols-12 gap-y-4">
                            ...
                            <div className="xl:col-span-12 col-span-12">
                                ...
                                <input type={(passwordshow2) ? 'text' : "password"} className="form-control form-control-lg !border-s !rounded-e-none" id="reset-newpassword" placeholder="New password"/>
                                        <SpkButton onclickfunc={()=>setpasswordshow2(!passwordshow2)} Label="button" variant="light" customClass="ti-btn !mb-0 !rounded-s-none" buttontype="button" Id="button-addon2"><i className={`${passwordshow2 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                                </div>
                            </div>
                            <div className="xl:col-span-12 col-span-12">
                                ...
                                <input type={(passwordshow3) ? 'text' : "password"} className="form-control form-control-lg !border-s !rounded-e-none" id="reset-confirmpassword" placeholder="Confirm password"/>
                                        <SpkButton onclickfunc={()=>setpasswordshow3(!passwordshow3)} Label="button" variant="light" customClass="ti-btn !mb-0 !rounded-s-none" buttontype="button" Id="button-addon2"><i className={`${passwordshow3 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                                </div>
                                <div className="mt-2">
                            ...
                            <div className="xl:col-span-12 col-span-12 grid">
                                <Link to={`${import.meta.env.BASE_URL}authentication/sign-in/signin-cover/`} className="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Create</Link>
                            </div>
                        </div>
                        <div className="text-center">
                            <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Already have an account? <Link to={`${import.meta.env.BASE_URL}authentication/sign-in/signin-cover/`} className="text-primary">Sign In</Link></p>
                        </div>
                    </div>
                </div>
                <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
        ...
        <div className="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 xl:block hidden px-0">
            <div className="authentication-cover">
                <div className="aunthentication-cover-content rounded">
                    ...
                    <SwiperComponent slides={ResetSwiper} spaceBetween={30} navigation={true} centeredSlides={true} autoplay={true} pagination={true}  className="mySwiper"/>
                    </div>
                </div>
            </div>
        </div>
