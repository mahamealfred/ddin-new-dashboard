...
const Createcover: FC<CoverProps> = () => {
              ...
              <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                <div className="p-[3rem]">
                  ...
                  <div className="btn-list">
                    <SpkButton buttontype="button" variant="light" Size="lg" customClass="ti-btn !font-medium me-[0.365rem] dark:border-defaultborder/10"><svg
                    ...
                    </svg>Sign In with google</SpkButton>
                    <SpkButton Label="button" buttontype="button" variant="primary" customClass="ti-btn ti-btn-icon me-[0.365rem]"><i className="ri-facebook-fill"></i></SpkButton>
                    <SpkButton Label="button" buttontype="button" variant="info" customClass="ti-btn ti-btn-icon"><i className="ri-twitter-x-line"></i></SpkButton>
                  </div>
                  ...
                  <div className="grid grid-cols-12 gap-y-4">
                    <div className="xl:col-span-12 col-span-12 mt-0">
                      ...
                      <div className="flex">
                        ...
                        <SpkButton onclickfunc={() => setpasswordshow1(!passwordshow1)} variant="light"
                          customClass="ti-btn !mb-0 !rounded-s-none"
                          Label="button" buttontype="button"><i className={`${passwordshow1 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                      </div>
                    </div>
                    <div className="xl:col-span-12 col-span-12 mb-2">
                      ...
                      <div className="flex">
                        ...
                        <SpkButton onclickfunc={() => setpasswordshow2(!passwordshow2)} variant="light"
                          customClass="ti-btn !mb-0 !rounded-s-none"
                          Label="button" buttontype="button"><i className={`${passwordshow2 ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle`}></i></SpkButton>
                      </div>
                      <div className="mt-2">
                    ...
                    <div className="xl:col-span-12 col-span-12 grid">
                      <SpkButton buttontype="button" customClass="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Save
                        Password</SpkButton>
                    </div>
                  </div>
