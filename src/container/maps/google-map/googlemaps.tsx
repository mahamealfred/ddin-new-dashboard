...
const Googlemaps: FC<GooglemapsProps> = () =>{
  ...
  return (
    <Fragment>
         <Pageheader currentpage="Google Maps" activepage="Maps" mainpage="Google Maps" />
            <div className="box custom-box">
                <div className="box-header">
                    <div className="box-title">Google Map</div>
                </div>
            ...
            <div className="box custom-box">
                <div className="box-header">
                    <div className="box-title">Los Angeles Map</div>
                </div>
                <div className="box-body">
                        <div style={{ height: "400px", width: "100%" }}>
                            <GoogleMapReact
