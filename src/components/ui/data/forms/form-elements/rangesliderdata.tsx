              ...
              <div
                ...
                style={{
                  ...
                  background: getTrackBackground({
                    values,
                    colors: ['#ccc', 'rgb(var(--primary))', '#ccc'],
                    min: MIN,
                    max: MAX,
                    rtl,
                  }),
            ...
            >
              ...
              <div
                style={{
                  height: '16px',
                  width: '5px',
                  backgroundColor: isDragged ? 'rgb(var(--primary))' : '#CCC',
                }}
              />
              </Fragment>
            </div>
          ...
          renderMark={({ props, index }) => (
            <div
              ...
              style={{
                ...
                height: '16px',
                width: '5px',
                backgroundColor: index * STEP < values[0] ? 'rgb(var(--primary))' : '#ccc',
              }}
            />
          )}
          renderTrack={({ props, children }) => (
