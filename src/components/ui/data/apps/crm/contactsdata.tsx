...
export const Loopingdata: loopingdata[] = [
    ...
    { id: 5, src1:face8, src2: logo6, name: 'Brenda Simpson', time: '19, Jul 2023 - 12:41PM', score: '516', mail: 'brendasimpson1993@gmail.com', cell: '1129-2302-1092 ', text1: 'Massive Dynamic', text2: 'Organic search', text3: 'Subscriber', text4: 'Partner', color1: 'pinkmain/10', color2: 'success/10', class1: 'pinkmain', class2: 'success' },
    ...
    { id: 7, src1:face15, src2: logo8, name: 'Dwayne Jhonson', time: '12, Jun 2023 - 11:38AM', score: '368', mail: 'dwayenejhonson78@gmail.com', cell: '7891-2093-1994 ', text1: 'Acme Corporation', text2: 'Blog Articles', text3: 'Trial User', text4: 'Cold Lead', color1: 'warning/10', color2: 'purplemain/10', class1: 'warning', class2: 'purplemain' },
    ...
    { id: 9, src1:face3, src2: logo10, name: 'Jessica Morris', time: '28, Jul 2023 - 9:31AM', score: '185', mail: 'jessicamorris289@gmail.com', cell: ' 1768-2332-4934 ', text1: 'Umbrella Corporation', text2: 'Affiliates', text3: 'New Lead', text4: 'Lost Customer', color1: 'primary/10', color2: 'light', class1: 'primary', class2: 'defaulttextcolor' },
    { id: 10, src1:face9, src2: logo2, name: 'Michael Jeremy', time: '28, Jul 2023 - 9:31AM', score: '240', mail: 'michaeljeremy186@gmail.com', cell: '4788-7822-4786 ', text1: 'Hooli Technologies', text2: 'Direct mail', text3: 'New Lead', text4: 'Subscriber', color1: 'primary/10', color2: 'pinkmain/10', class1: 'primary', class2: 'pinkmain' }
];
