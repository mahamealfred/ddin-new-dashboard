  ...
  text5:string
   ...
   interface Productdetails {
    ...
    name:string
     ...
     {id:1, class:'border-b border-defaultborder', name:'Artist Name',title:'Json Taylor'},
     {id:2, class:'border-b border-defaultborder', name:'Royality',title:'10% royalty paid to the artist on secondary sales'},
     {id:3, class:'border-b border-defaultborder', name:'Total Bids',title:' 32'},
     {id:4, class:'border-b border-defaultborder', name:'Current Owner',title:'Nikki Jones'},
     {id:5, class:'', name:'NFT Type',title:' Digital art work'},
     ];
