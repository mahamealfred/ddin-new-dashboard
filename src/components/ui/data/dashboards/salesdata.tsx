...
//***   Sale Value--- Start ***//
export const Saleseries = [60]
export const Saleoptions:any = {
  chart: {
      height: 225,
      events: {
          mounted: (chart:any) => {
...
export function MapData({ setTooltipContent }:any) {
    const [_position, _setPosition] = useState<any>({ coordinates: [0, 0], zoom: 1 });
...
export const Trendingorders: orders[] = [
  { id: 1, orderid: '#1537890', src:face15, name: 'Simon Cowall', quantity: '1', price: '$4320.29', status: 'Shipped', date: '25,Nov 2022', color: 'success', bg: 'success/10' },
  { id: 2, orderid: '#1539078', src:face4, name: 'Meisha Kerr', quantity: '1', price: '$6745.99', status: 'Cancelled', date: '29,Nov 2022', color: 'danger', bg: 'danger/10' },
  { id: 3, orderid: '#1539832', src:face5, name: 'Jessica', quantity: '2', price: '$1176.89', status: 'Under Process', date: '04,Dec 2022', color: 'info', bg: 'info/10' },
  { id: 4, orderid: '#1539832', src:face6, name: 'Amanda B', quantity: '1', price: '$1899.99', status: 'Shipped', date: '10,Dec 2022', color: 'success',bg: 'success/10' },
  { id: 5, orderid: '#1538267', src:face11, name: 'Jason Stathman', quantity: '1', price: '$1867.29', status: 'Pending', date: '18,Dec 2022', color: 'warning',bg: 'warning/10' },
  { id: 6, orderid: '#1537890', src:face13, name: 'Khabib Hussain', quantity: '1', price: '$2439.99', status: 'Success', date: '24,Dec 2022', color: 'success',bg: 'success/10' },
];
...
export const completedTasks = [
 ...
 export const  Salesusers =[
  { name: "Samantha Melon", text: "User ID: #1234", balance: "11.43am", avatar: face2, },
  { name: "Allie Grater", text: "User ID: #3432", balance: "12.35pm", avatar: face1, },
  { name: "Gabe Lackmen", text: "User ID: #2312", balance: "Yeserday", avatar: face5, },
  { name: "Manuel Labor", text: "User ID: #4231", balance: "24 Mar 2022", avatar: face7, },
  { name: "Hercules Bing", text: "User ID: #1754", balance: "18 Mar 2022", avatar: face9, },
  { name: "Manuel Labor", text: "User ID: #1345", balance: "15 Mar 2022", avatar: face11, },
]
export const Recenttransactiondata= [
  { name: "Shopping", text: "card", price: "-$256.99 ", bgColor: "bg-primary", date: "Mar 12,2022", color: "danger", svgIcon: <><svg xmlns="http://www.w3.org/2000/svg" className="svg-white" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><g><rect fill="none" height="24" width="24"></rect><path d="M18,6h-2c0-2.21-1.79-4-4-4S8,3.79,8,6H6C4.9,6,4,6.9,4,8v12c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V8C20,6.9,19.1,6,18,6z M12,4c1.1,0,2,0.9,2,2h-4C10,4.9,10.9,4,12,4z M18,20H6V8h2v2c0,0.55,0.45,1,1,1s1-0.45,1-1V8h4v2c0,0.55,0.45,1,1,1s1-0.45,1-1V8 h2V20z"></path></g></svg></> },
  { name: "Stock Market", text: "Transfer", price: "+$18,567.00 ", bgColor: "bg-info", date: "Mar 10,2022", color: "success", svgIcon:<><svg xmlns="http://www.w3.org/2000/svg" className="svg-white" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g><path d="M20,2H4C3,2,2,2.9,2,4v3.01C2,7.73,2.43,8.35,3,8.7V20c0,1.1,1.1,2,2,2h14c0.9,0,2-0.9,2-2V8.7c0.57-0.35,1-0.97,1-1.69V4 C22,2.9,21,2,20,2z M19,20H5V9h14V20z M20,7H4V4h16V7z"></path><rect height="2" width="6" x="9" y="12"></rect></g></g></svg></> },
  { name: "Grocery", text: "card", price: "-$256.99 ", bgColor: "bg-warning", date: "Apr 23,2022", color: "danger", svgIcon: <svg xmlns="http://www.w3.org/2000/svg" className="svg-white" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2zm-1.45-5c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.37-.66-.11-1.48-.87-1.48H5.21l-.94-2H1v2h2l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h12v-2H7l1.1-2h7.45zM6.16 6h12.15l-2.76 5H8.53L6.16 6z"></path></svg> },
  { name: "Business", text: "Transfer", price: "+$256.99 ", bgColor: "bg-danger", date: "May 4,2022", color: "success", svgIcon: <svg xmlns="http://www.w3.org/2000/svg" className="svg-white" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g></g><g><path d="M21.9,8.89l-1.05-4.37c-0.22-0.9-1-1.52-1.91-1.52H5.05C4.15,3,3.36,3.63,3.15,4.52L2.1,8.89 c-0.24,1.02-0.02,2.06,0.62,2.88C2.8,11.88,2.91,11.96,3,12.06V19c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2v-6.94 c0.09-0.09,0.2-0.18,0.28-0.28C21.92,10.96,22.15,9.91,21.9,8.89z M18.91,4.99l1.05,4.37c0.1,0.42,0.01,0.84-0.25,1.17 C19.57,10.71,19.27,11,18.77,11c-0.61,0-1.14-0.49-1.21-1.14L16.98,5L18.91,4.99z M13,5h1.96l0.54,4.52 c0.05,0.39-0.07,0.78-0.33,1.07C14.95,10.85,14.63,11,14.22,11C13.55,11,13,10.41,13,9.69V5z M8.49,9.52L9.04,5H11v4.69 C11,10.41,10.45,11,9.71,11c-0.34,0-0.65-0.15-0.89-0.41C8.57,10.3,8.45,9.91,8.49,9.52z M4.04,9.36L5.05,5h1.97L6.44,9.86 C6.36,10.51,5.84,11,5.23,11c-0.49,0-0.8-0.29-0.93-0.47C4.03,10.21,3.94,9.78,4.04,9.36z M5,19v-6.03C5.08,12.98,5.15,13,5.23,13 c0.87,0,1.66-0.36,2.24-0.95c0.6,0.6,1.4,0.95,2.31,0.95c0.87,0,1.65-0.36,2.23-0.93c0.59,0.57,1.39,0.93,2.29,0.93 c0.84,0,1.64-0.35,2.24-0.95c0.58,0.59,1.37,0.95,2.24,0.95c0.08,0,0.15-0.02,0.23-0.03V19H5z"></path></g></g></svg> },
  { name: "Books", text: "card", price: "-$256.99 ", bgColor: "bg-success", date: "May 18,2022", color: "danger", svgIcon: <svg xmlns="http://www.w3.org/2000/svg" className="svg-white" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H8V4h12v12zM10 9h8v2h-8zm0 3h4v2h-4zm0-6h8v2h-8z"></path></svg> },
  { name: "Sports", text: "card", price: "-$256.99 ", bgColor: "bg-pinkmain", date: "Apr 30,2022", color: "danger", svgIcon: <svg xmlns="http://www.w3.org/2000/svg" className="svg-white" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g><path d="M21.58,16.09l-1.09-7.66C20.21,6.46,18.52,5,16.53,5H7.47C5.48,5,3.79,6.46,3.51,8.43l-1.09,7.66 C2.2,17.63,3.39,19,4.94,19h0c0.68,0,1.32-0.27,1.8-0.75L9,16h6l2.25,2.25c0.48,0.48,1.13,0.75,1.8,0.75h0 C20.61,19,21.8,17.63,21.58,16.09z M19.48,16.81C19.4,16.9,19.27,17,19.06,17c-0.15,0-0.29-0.06-0.39-0.16L15.83,14H8.17 l-2.84,2.84C5.23,16.94,5.09,17,4.94,17c-0.21,0-0.34-0.1-0.42-0.19c-0.08-0.09-0.16-0.23-0.13-0.44l1.09-7.66 C5.63,7.74,6.48,7,7.47,7h9.06c0.99,0,1.84,0.74,1.98,1.72l1.09,7.66C19.63,16.58,19.55,16.72,19.48,16.81z"></path><polygon points="9,8 8,8 8,10 6,10 6,11 8,11 8,13 9,13 9,11 11,11 11,10 9,10"></polygon><circle cx="17" cy="12" r="1"></circle><circle cx="15" cy="9" r="1"></circle></g></g></svg> },
]
...
export const  invoices = [
  { id: 'A12-005', amount: "$1,938", status: 'Processing', statusClass: 'info', date: 'Nov 24, 2022' ,class:'mb-2'},
  { id: 'A12-006', amount: "$1,098", status: 'Sent', statusClass: 'success', date: 'Nov 28, 2022' ,class:'mb-2'},
  { id: 'A12-007', amount: "$3,672", status: 'Pending', statusClass: 'warning', date: 'Dec 20, 2022' ,class:'mb-2'},
  { id: 'A12-008', amount: "$4,362", status: 'Processing', statusClass: 'info', date: 'Dec 16, 2022' ,class:'mb-2'},
  { id: 'A12-009', amount: "$2,389", status: 'Sent', statusClass: 'success', date: 'Dec 10, 2022' ,class:'mb-2'},
  { id: 'A12-002', amount: "$4,390", status: 'Sent', statusClass: 'success', date: 'Nov 30, 2022' ,class:'mb-2'}
]
export const transactions = [
  { name: "Order Picking", amount: "+$3,876",  percentage: "03", timeAgo: "5 days ago" },
  { name: "Storage", amount: "-$2,178", percentage: "16", timeAgo: "2 days ago" },
  { name: "Shipping", amount: "+$1,367",  percentage: "06", timeAgo: "1 day ago" },
  { name: "Receiving", amount: "-$678", percentage: "25", timeAgo: "10 days ago" },
  { name: "Review", amount: "+$578",  percentage: "55", timeAgo: "11 days ago" },
  { name: "Profit", amount: "+$27,215",  percentage: "32", timeAgo: "11 days ago" }
]
