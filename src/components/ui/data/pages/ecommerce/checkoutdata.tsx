...
function Button({ visible, disabled, ...props }: any) {
    return (
        ...
        <button className={visible ? `ti-btn ti-btn-primary-full text-white` : "invisible"} {...props}/>
                                    ...
                                    <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                        <div className="ti-modal-content">
                                            <div className="ti-modal-header">
                                                ...
                                                <SpkButton buttontype="button" customClass="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor" Overlay="#modal-new-address">
                                            ...
                                            <div className="ti-modal-footer">
                                                <SpkButton buttontype="button"
                                                    ...
                                                    Overlay="#modal-new-address">
                                                    Close
                                                </SpkButton>
                                                <SpkButton buttontype="button" customClass="ti-btn bg-primary text-white !font-medium">Save Adress</SpkButton>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="p-4">
                                            ...
                                            <div className="grid grid-cols-12 gap-4">
                                                ...
                                                <div className="xxl:col-span-4 col-span-12">
                                                    ...
                                                    <SelectComponent option={Citydata} mainClass='w-full !rounded-md' searchable={true} defaultvalue={[Citydata[0]]}/>
                                                </div>
                                                <div className="xxl:col-span-4 col-span-12">
                                                    <label htmlFor="choices-single-default1" className="form-label">State</label>
                                                    <SelectComponent option={Statedata} mainClass='w-full !rounded-md' searchable={true} defaultvalue={[Statedata[0]]}/>
                                                </div>
                                                <div className="xxl:col-span-2 col-span-12">
                                                ...
                                                <div className="xl:col-span-12 col-span-12">
                                                    <div className="mb-4">
                                                        ...
                                                        <div className="input-group">
                                                            ...
                                                            <SpkButton buttontype="button" variant="info" customClass="ti-btn border-defaultborder !rounded-s-none !mb-0" Id="payment-address">Change</SpkButton>
                                                        </div>
                                                    </div>
