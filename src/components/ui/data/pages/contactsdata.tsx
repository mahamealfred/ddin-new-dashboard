...
export const contactsdata:contacts[] = [
    ...
    { id: 16, class: "Linda Simson", email: "lindasimson@gmail.com", phn: "+1(555) 234 9345", icon: icon1, src: face21 },
    { id: 17, class: "Umaga Nigel", email: "umaganigel89@gmail.com", phn: "+1(555) 783 0213", icon: icon2, src: face14 },
    { id: 18, class: "Json Taylor", email: "jsontaylor@gmail.com", phn: "+1(555) 234 2452", icon: icon1, src: face8 },
