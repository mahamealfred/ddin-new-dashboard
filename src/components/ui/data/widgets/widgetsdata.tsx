...
//***   Bitcoin --- Start  ***//
export const Bitcoinseries = [
  {
    data: [34, 55, 41, 67, 22, 43, 21]
  },
]
export const Bitcoinoptions:any = {
  chart: {
    events: {
      mounted: (chart:any) => {
...
//***   Ethereum --- Start  ***//
export const Ewidgetseries = [
  {
    data: [34, 55, 41, 47, 32, 53, 31]
  },
]
export const Ewidgetoptions:any = {
  chart: {
    events: {
      mounted: (chart:any) => {
        chart.windowResizeHandler();
...
//***   Dash --- Start  ***//
export const Dwidgetseries = [
  {
    data: [31, 53, 32, 47, 41, 55, 44]
  },
]
export const Dwidgetoptions:any = {
  chart: {
    events: {
      mounted: (chart:any) => {
        chart.windowResizeHandler();
...
//***   Golem --- Start  ***//
export const Gwidgetseries = [
  {
    data: [21, 43, 22, 45, 35, 55, 34]
  },
]
export const Gwidgetoptions:any = {
  chart: {
    events: {
      mounted: (chart:any) => {
        chart.windowResizeHandler();
...
//***  Target Report --- End  ***//
  ...
  export const Widgetcarddata=[
    {id:1, title:"Apple", ratio:"$12,289.44", increment:"+$1,780.80", text:"0.14%", icon:"ri-apple-fill", customBodyClass:"!p-0", customClass:"custom-box p-4", avatarclass:"border text-[#8c9097] dark:text-white/50 !text-primary dark:border-defaultborder/10"},
    {id:2, title:"Bitcoin", ratio:"$58,151.02", increment:"+$5,745.62", text:"2.14%", icon:"ri-bit-coin-fill", customBodyClass:"!p-0", customClass:"custom-box p-4", avatarclass:"border text-[#8c9097] dark:text-white/50 !text-primary dark:border-defaultborder/10"},
   ]
    
export const Businessdata=[
  {id:1, class:'border-e border-dashed dark:border-defaultborder/10', icon:'package', text:'Total Products', value:'45,280', color:'primary', percentage:'1.31%'},
  {id:2, class:'border-e border-dashed dark:border-defaultborder/10', icon:'rocket', text:'Total Sales', value:'10,500', color:'secondary', percentage:'1.14%'},
  {id:3, class:'border-e border-dashed dark:border-defaultborder/10', icon:'wallet', text:'Income', value:'$69,270', color:'success', percentage:'2.58%'},
  {id:4, class:'', icon:'packge-import', text:'Total Orders', value:'12,088', color:'warning', percentage:'12.05%'},
]
export const Trafficdata=[
{id:1, title:'Google', icon:'google-fill', session:'23,379', views:'16,890', width: "w-[34%]", color:'primary', value:34, arrowicon :'up'},
{id:2, title:'Safari', icon:'safari-line', session:'78,973', views:'29,906', width: "w-[58%]", color:'secondary', value:58, arrowicon :'up'},
{id:3, title:'Opera', icon:'opera-fill', session:'12,457', views:'8,674', width: "w-[62%]", color:'success', value:62, arrowicon :'down'},
{id:4, title:'Edge', icon:'edge-fill', session:'8,570', views:'4,980', width:"w-[71%]", color:'info', value:71, arrowicon :'up'},
{id:5, title:'Firefox', icon:'firefox-fill', session:'6,135', views:'4,436', width: "w-[48%]", color:'warning', value:48, arrowicon :'down'},
{id:6, title:'Ubuntu', icon:'ubuntu-fill', session:'4,789', views:'2,447', width: "w-[28%]", color:'danger', value:28, arrowicon :'up'}
];
 export const widgetcardadata=[
  {Id:"btcCoin", options:Bitcoinoptions, series:Bitcoinseries, Title:"Bitcoin" ,SubTitle:"BTC", Value:"$12,800", Percentage:"+25.8%", SvgIcon:<> <svg xmlns="http://www.w3.org/2000/svg" className="fill-info" viewBox="0 0 128 128"><path d="M64 128C28.7 128 0 99.3 0 64S28.7 0 64 0s64 28.7 64 64-28.7 64-64 64z" /><path fill="#fff" d="M94.3 71.4c-.5-3.6-2.3-6.4-5.4-8.2-1.4-.8-3.1-1.4-4.7-2.1.2-.1.3-.3.4-.3 7.9-4.1 7.2-16.3 1.5-20.5-2.3-1.7-4.9-2.8-7.7-3.4-2-.4-3.9-.7-6-1.1 0-3.5.1-8.5.1-12.4H65c0 3.8-.1 8.7-.1 12.1H59c0-3.5 0-8.3.1-12.1h-7.4c0 4-.1 8.8-.1 12.3-5.1 0-10-.1-15-.1 0 2.7 0 5.3-.1 7.9h3c.9 0 1.9 0 2.8.1 2.6.2 3.9 1.6 3.9 4.2l-.3 31.9c0 2.3-1 3.3-3.3 3.3h-5c-.5 3-1 5.9-1.6 8.9 5 .1 10 .1 15 .2 0 3.8 0 8.7-.1 12.7h7.4c0-4 .1-8.7.1-12.5 2.1.1 4 .1 5.9.2 0 3.8-.1 8.4-.1 12.3h7.4c0-4 .1-8.7.1-12.4.3 0 .5-.1.6-.1 3.5-.6 7.2-.9 10.6-1.7 4.5-1.1 8.1-3.7 9.9-8.2 1.7-3.6 2-7.2 1.5-11zM59 44.3c4.6 0 9.1-.4 13.4 1.5 2.8 1.2 4.2 3.5 4 6.3-.2 2.9-1.9 5-4.8 6-4.1 1.3-8.3 1.3-12.7 1.1 0-5 .1-9.8.1-14.9zm16.2 37.1c-4.1 1.8-8.5 1.8-12.8 1.9-1.2 0-2.4-.1-3.8-.1.1-5.5.1-10.9.2-16.4 5.6 0 11.2-.4 16.5 1.9 2.7 1.2 4.3 3.3 4.3 6.4 0 3.1-1.6 5.1-4.4 6.3z" /></svg></>},
  {Id:"ethCoin", options:Ewidgetoptions, series:Ewidgetseries, Title:"Ethereum" ,SubTitle:"ETH", Value:"$18,600", Percentage:"+12.9%", SvgIcon:<><svg xmlns="http://www.w3.org/2000/svg" className="fill-success" viewBox="0 0 128 128"><path d="M64 128C28.7 128 0 99.3 0 64S28.7 0 64 0s64 28.7 64 64-28.7 64-64 64z" /><path fill="#fff" d="M65.2 87.2v22.7l28.1-39.5zM92.3 63.1l-27.1-45v32.7zM65.2 53.3v28l26.9-15.7zM35.8 63.1l27-45v32.7zM62.8 53.3v28L35.9 65.6zM62.8 87.2v22.7L34.7 70.4z" /></svg></>},
  {Id:"dshCoin",options:Dwidgetoptions, series:Dwidgetseries, Title:"Dash" ,SubTitle:"DSH", Value:"$16,580", Percentage:"+15.7%" , SvgIcon:<><svg xmlns="http://www.w3.org/2000/svg" className="fill-danger" viewBox="0 0 128 128"><path d="M64 128C28.7 128 0 99.3 0 64S28.7 0 64 0s64 28.7 64 64-28.7 64-64 64z" /><path fill="#fff" d="M20.8 89.3c1.4-4.1 2.7-7.9 4.1-11.8.1-.4.9-.7 1.3-.7 2.3-.1 4.7 0 7 0H79c1.2 0 1.8-.4 2.1-1.5 2.5-7.5 5.2-15 7.8-22.5.1-.4.2-.8.4-1.4H33.8c1.4-4.2 2.8-8.1 4.1-12 .1-.3.7-.6 1.1-.6 1.4-.1 2.8 0 4.2 0 18.8 0 37.6.1 56.3-.1 5.6-.1 11.6 4.3 9.2 12.5-1.8 6.1-4.1 12.1-6.2 18.2-.7 2.1-1.4 4.1-2.1 6.2-2.6 7.2-7.9 11.6-15.2 13.6-.7.2-1.4.2-2.1.2H22.3c-.4-.1-.8-.1-1.5-.1z" /><path fill="#fff" d="M55.9 58.1c-1.4 4-2.8 7.7-4.2 11.4-.1.3-.7.5-1 .5H19.2c-.1 0-.3-.1-.6-.2 1.3-3.7 2.6-7.3 4-10.9.1-.3.7-.7 1-.7 10.7-.1 21.4-.1 32.3-.1z" /></svg></>},
  {Id:"glmCoin", options:Gwidgetoptions, series:Gwidgetseries, Title:"Golem" ,SubTitle:"GLM", Value:"$12,545", Percentage:"+12.1%", SvgIcon:<><svg xmlns="http://www.w3.org/2000/svg" className="fill-warning" viewBox="0 0 128 128"><path d="M64 128C28.7 128 0 99.3 0 64S28.7 0 64 0s64 28.7 64 64-28.7 64-64 64z" /><path fill="#fff" d="M63.8 22.6c3.7-.1 7.2.6 10.2 2.7 1.4.9 2.4.8 3.6-.5 2.4-2.6 5-5 7.5-7.6.9-.9 1.8-1.5 2.9-.2 1.1 1.1.8 2-.2 2.9-2.6 2.6-5 5.2-7.6 7.8-1.1 1.1-1.3 1.9-.5 3.3 5.8 10.4 2.9 22.5-8.6 28.1-1.1.5-2.3.8-3.5 1-1.4.3-1.9 1-1.9 2.5.1 3 .1 6 0 8.9 0 1.6.5 2.3 2.1 2.7 6.2 1.5 10.6 5.2 13.3 10.9 2.6 5.5 1.9 15.4-3.8 21.3-4.8 4.9-13.2 6.9-19.5 4.4-7.5-3-12.1-9.6-12.2-17.5-.1-9.6 5.1-16.4 14.3-19 1.4-.4 2.2-1 2.1-2.5-.1-3.4 0-6.8-.2-10.2 0-.6-1.1-1.4-1.8-1.6-6-1.6-10.4-5.2-12.9-10.8-5.6-13 4.3-27.4 16.7-26.6zM79 92.8c0-7.9-6.9-15.1-14.5-15.1-8-.1-15.3 7-15.4 15-.1 7.9 7.3 15.6 14.9 15.5 8.1-.1 15-7.2 15-15.4zM49.3 41.1c0 8.6 6.6 15.6 14.9 15.6 7.7 0 14.8-7.1 14.8-15.1 0-7.4-5.5-15.2-14.7-15-8.4.1-14.9 6.3-15 14.5z" /></svg></>}
 ];

 export const Progresscarddata=[
{Color:"!text-primary" , Icon:"users" , Value:"2,460" , Title:'Total Candidates', text:"Magna sit elitr kasd consetetur." , Percentage:'w-[14%]' , Progresstext:"14"  , Increment:"2.5%"},
{Color:"!text-secondary" , Icon:"user-circle" , Title:'Recruiters', text:"Elitr at gubergren sit sed."  , Value:"7,539"  , Percentage:'w-[55%]' , Progresstext:"55"  , Increment:"3.1%"},
{Color:"!text-success" , Icon:"view-360" , Title:'Page Views', text:"Sed duo ut sanctus gubergren."  , Value:"13,693"  , Percentage:'w-[24%]' , Progresstext:"24" , Increment:"5.4%" },
{Color:"!text-indigomain" , Icon:"view-360" , Title:'Total Subscriptions', text:"Invidunt magna voluptua."  , Value:"1,116"  , Percentage:'w-[67%]' , Progresstext:"67"  , Increment:"3.2%" }
 ]