...
//***  Multiple Colored TImeline Chart --- Start ***//
...
//***  Multiple Colored TImeline Chart --- End ***//


//***  Multi Series Timeline Chart --- Start ***//
export const MultiTseries = [
                {
                    name: 'Bob',
                    data: [
                        {
...
export const MultiToptions:any = {
                chart: {
                    height: 320,
                    type: 'rangeBar',
                    events: {
...
export const Advanceoptions:any = {
                chart: {
                    height: 320,
                    type: 'rangeBar',
                    events: {
...
export const Tgroupoptions:any = {
                chart: {
                    height: 320,
                    type: 'rangeBar',
                    events: {
