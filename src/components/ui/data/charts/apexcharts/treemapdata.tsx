...
export const Dimensionalseries = [
    {
        name: 'Desktops',
        data: [
            {
...
export const  Dimensionaloptions:any = {
...
export const Distributeoptions:any = {
    legend: {
        show: false
    },
    chart: {
...
//*** Treemap with color ranges ---Start ***//
...
export const Treecoloroptions:any = {
    legend: {
        show: false
    },
    chart: {
