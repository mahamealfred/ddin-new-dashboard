...
export const Stackbarseries = [{
 ...
 export const Stackbaroptions:any = {
                chart: {
                    type: 'bar',
                    height: 320,
                    stacked: true,
...
export const Optionsbar100:any = {
                chart: {
                    type: 'bar',
                    height: 320,
                    stacked: true,
...
//*** Bar Chart With Negative Values --- Start ***//
...
//*** Bar Chart With Negative Values --- End ***//

//*** Bar Chart With Markers --- Start ***//
export const Makerseries = [
                {
                    name: 'Actual',
                    data: [
                        {
...
export const Reverseseries = [{
                data: [400, 430, 448, 470, 540, 580, 690]
            }]
export const Reverseoptions:any = {
                chart: {
                    type: 'bar',
                    height: 320,
                    events: {
...
//*** Bar With Categogry DataLabels --- Start ***//
export const Cateseries = [{
                data: [400, 430, 448, 470, 540, 580, 690, 1100, 1200, 1380]
            }]
export const Cateoptions:any = {
                chart: {
                    type: 'bar',
                    height: 320,
                    events: {
...
//*** Bar With Categogry DataLabels --- End ***//


//*** Patterned Bar Chart --- Start ***//
export const Patternseries = [{
                name: 'Marine Sprite',
                data: [44, 55, 41, 37, 22, 43, 21]
            }, {
                name: 'Striking Calf',
