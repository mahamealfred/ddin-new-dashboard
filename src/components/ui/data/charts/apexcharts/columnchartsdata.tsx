...
export const Labelsseries = [{
    name: 'Inflation',
    data: [2.3, 3.1, 4.0, 10.1, 4.0, 3.6, 3.2, 2.3, 1.4, 0.8, 0.5, 0.2]
}]
export const Labeloptions:any = {
    chart: {
        height: 320,
        type: 'bar',
        events: {
...
//*** Column Chart With Rotated Labels --- Start ***//
export const Rotateseries = [{
    name: 'Servings',
    data: [44, 55, 41, 67, 22, 43, 21, 33, 45, 31, 87, 65, 35]
}]
export const Rotateoptions:any = {
    annotations: {
        points: [{
            x: 'Bananas',
            seriesIndex: 0,
...
//*** Column Chart With Rotated Labels --- End ***//
...
export const Dynamicoptions:any = {
    chart: {
        id: 'barYear',
        height: 400,
        width: '100%',
