...
export const Candleoptions:any = {
    chart: {
        type: 'candlestick',
        height: 350,
        events: {
...
//*** Candlestick Synced With Brush Chart ---Start ***//
const seriesData = [{
...
export const Candlesseries = [{
    data: seriesData
}]
export const Candlesoptions:any = {
    chart: {
        type: 'candlestick',
        height: 215,
        id: 'candles',
...
//*** Candlestick Synced With Brush Chart ---End ***//


//*** Candlestick With Cateory X-axis ---Start ***//
export const Axisseries = [{
    data: seriesData
}]
export const Axisoptions:any = {
    chart: {
        type: 'candlestick',
        height: 215,
        id: 'candles',
...
//*** Candlestick With Cateory X-axis ---End ***//


//*** Candlestick With Line Chart ---Start ***//
export const Linecseries = [{
    name: 'line',
    type: 'line',
    color: "#49b6f5",
    data: [
...
//*** Candlestick With Line Chart ---End ***//
