 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ra(r,e,t){let n;return n=r?t&&(t.merge||t.mergeFields)?r.toFirestore(e,t):r.toFirestore(e):e,n}class IR extends bu{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ot(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ve(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e){this._delegate=e}static serverTimestamp(){const e=LR();return e._methodName="FieldValue.serverTimestamp",new zn(e)}static delete(){const e=OR();return e._methodName="FieldValue.delete",new zn(e)}static arrayUnion(...e){const t=MR(...e);return t._methodName="FieldValue.arrayUnion",new zn(t)}static arrayRemove(...e){const t=FR(...e);return t._methodName="FieldValue.arrayRemove",new zn(t)}static increment(e){const t=UR(e);return t._methodName="FieldValue.increment",new zn(t)}isEqual(e){return this._delegate.isEqual(e._delegate)}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WR={Firestore:c_,GeoPoint:ya,Timestamp:ye,Blob:vs,Transaction:l_,WriteBatch:u_,DocumentReference:pt,DocumentSnapshot:Is,Query:Je,QueryDocumentSnapshot:ws,QuerySnapshot:Qc,CollectionReference:ei,FieldPath:Su,FieldValue:zn,setLogLevel:zR,CACHE_SIZE_UNLIMITED:X0};function KR(r,e){r.INTERNAL.registerComponent(new Ct("firestore-compat",t=>{const n=t.getProvider("app-compat").getImmediate(),i=t.getProvider("firestore").getImmediate();return e(n,i)},"PUBLIC").setServiceProps(Object.assign({},WR)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
