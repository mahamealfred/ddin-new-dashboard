...
function y(l3, u3, i3) {
  var t3, r3, o3, f3 = {};
  for (o3 in u3) "key" == o3 ? t3 = u3[o3] : "ref" == o3 ? r3 = u3[o3] : f3[o3] = u3[o3];
...
function $() {
  ...
  }); n2 = r.shift(); ) n2.__d && (l3 = r.length, i3 = void 0, t3 = void 0, f3 = (o3 = (u3 = n2).__v).__e, (e3 = u3.__P) && (i3 = [], (t3 = h({}, o3)).__v = o3.__v + 1, M(e3, o3, t3, u3.__n, void 0 !== e3.ownerSVGElement, null != o3.__h ? [f3] : null, i3, null == f3 ? A(o3) : f3, o3.__h), N(i3, o3), o3.__e != f3 && P(o3)), r.length > l3 && r.sort(function(n3, l4) {
    return n3.__v.__b - l4.__v.__b;
  }));
  $.__r = 0;
}
function H(n2, l3, u3, i3, t3, r3, o3, f3, e3, a3) {
  ...
  for (u3.__k = [], h3 = 0; h3 < l3.length; h3++) if (null != (d3 = u3.__k[h3] = null == (d3 = l3[h3]) || "boolean" == typeof d3 ? null : "string" == typeof d3 || "number" == typeof d3 || "bigint" == typeof d3 ? p(null, d3, null, null, d3) : Array.isArray(d3) ? p(_, { children: d3 }, null, null, null) : d3.__b > 0 ? p(d3.type, d3.props, d3.key, d3.ref ? d3.ref : null, d3.__v) : d3)) {
    if (d3.__ = u3, d3.__b = u3.__b + 1, null === (y3 = m3[h3]) || y3 && d3.key == y3.key && d3.type === y3.type) m3[h3] = void 0;
...
function z(n2, l3, u3, i3, t3, r3) {
  ...
  else if (null == u3 || t3 != r3 || null == t3.parentNode) n: if (null == r3 || r3.parentNode !== n2) n2.appendChild(t3), o3 = null;
  else {
  ...
  try {
    n: if ("function" == typeof $3) {
      ...
      if (a3.context = m3, a3.props = b3, a3.__P = n2, A4 = l.__r, P4 = 0, "prototype" in $3 && $3.prototype.render) {
        for (a3.state = a3.__s, a3.__d = false, A4 && A4(u3), s3 = a3.render(a3.props, a3.state, a3.context), C3 = 0; C3 < a3._sb.length; C3++) a3.__h.push(a3._sb[C3]);
        a3._sb = [];
      } else do {
    ...
    } else null == o3 && u3.__v === i3.__v ? (u3.__k = i3.__k, u3.__e = i3.__e) : u3.__e = O(i3.__e, u3, i3, t3, r3, o3, f3, c3);
    (s3 = l.diffed) && s3(u3);
  } catch (n3) {
...
function O(l3, u3, i3, t3, r3, o3, f3, e3) {
  ...
  if (null === d3) y3 === p3 || e3 && l3.data === p3 || (l3.data = p3);
  else {
    ...
    else if (_3 = u3.props.children, H(l3, Array.isArray(_3) ? _3 : [_3], u3, i3, t3, r3 && "foreignObject" !== d3, o3, f3, o3 ? o3[0] : i3.__k && A(i3, 0), e3), null != o3) for (_3 = o3.length; _3--; ) null != o3[_3] && v(o3[_3]);
...
var init_preact_module = __esm({
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = s.slice, l = { __e: function(n2, l3, u3, i3) {
      for (var t3, r3, o3; l3 = l3.__; ) if ((t3 = l3.__c) && !t3.__) try {
        if ((r3 = t3.constructor) && null != r3.getDerivedStateFromError && (t3.setState(r3.getDerivedStateFromError(n2)), o3 = t3.__d), null != t3.componentDidCatch && (t3.componentDidCatch(n2, i3 || {}), o3 = t3.__d), o3) return t3.__E = t3;
      } catch (l4) {
        n2 = l4;
      }
      throw n2;
...
//# sourceMappingURL=chunk-22QCOM3E.js.map
